<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DanhSachCongNoBenhNhan.aspx.cs"
    Inherits="KhoaSan_DanhSachCongNoBenhNhan" %>
   ...
   if (confirm("Đã Lưu tạm ứng. Bạn có muốn in phiếu báo tạm ứng không ?"))
	     {
            ...
            window.open("../CapCuu/frmPhieuBaoThuTamUng.aspx?dkMenu=capcuu&hdIdTamUng="+hdIdTamUng+"#isPrint=1");        
        }
   }
</script>
...
<form id="Form1"  method="post" runat="server">
    <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #C0C0C0">
        <tr>
            <td width="100%" align="left" style="background-color:#D4D0C8; height: 22px;">
                            ...
                            <table id="user" cellspacing="1" cellpadding="1" width="100%" border="0" class="khung">
                                <tr>
                                    <td class="title" align="center" style="background-color: #4D67A2; height: 21px;">
                                        <span class="title" style="color: #FFFFFF"><strong>THEO DÕI CÔNG NỢ BỆNH NHÂN - TẠM ỨNG</strong></span></td>
                                </tr>
                                <tr>
                                    <td width="100%">
                                                ...
                                                <td valign="top" align="center" width="100%" style="height: 64px">
                                                    <table cellspacing="0" cellpadding="0" width="98%" border="0" style="height: 14px">
                                                        <tr style="padding-bottom: 5px; padding-top: 10px">
                                                            ...
                                                            <fieldset style="border-width:thick;padding-bottom:15px;">
                                                                <legend>Tìm Bệnh Nhân - Tạm Ứng</legend>
                                                                <table cellspacing="0" cellpadding="0" border="0" style="width: 1236px">
                                                                    <tr>
                                                                        ...
                                                                        <td style="padding-top: 2px; height: 26px;" align="left">
                                                                            <span class="ptext">
                                                                                <asp:textbox id="txtMaBenhNhan" runat="server" width="178px" ></asp:textbox>
                                                                                &nbsp; &nbsp;
                                                                                &nbsp; &nbsp;Tên bệnh nhân: &nbsp; &nbsp;&nbsp;
                                                                                <asp:textbox id="txtTenBenhNhan" runat="server" width="178px" ></asp:textbox>&nbsp;&nbsp; &nbsp;&nbsp; Ngày vào viện:
                                                                                <asp:textbox id="txtRaVienLuc" runat="server" width="123px"  onfocus="$(this).datepick();" onblur="nvk_testDate_this(this);" ></asp:textbox>
                                                                                <%--<asp:imagebutton id="ImageButton1" runat="server" imageurl="../images/tim.png" onclick="ImageButton1_Click"></asp:imagebutton>
                                                                                <asp:imagebutton id="btnCancel" onclick="btnCancel_Click" runat="server" imageurl="../images/MOI.gif"></asp:imagebutton></span></td>
                                                                                --%>
                                                                                &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
                                                                                <asp:button id="btnTim" text="Tìm" runat="server" OnClick="btnTim_Click" Width="70px" Font-Bold="True" ForeColor="Blue"/>
                                                                                &nbsp;&nbsp;
                                                                                <asp:button id="btnCancel"  text="Mới" runat="server" OnClick="btnCancel_Click" Width="70px" Font-Bold="True" ForeColor="Blue"/></span></td>
                                                                    </tr>
                                                                    <!--
                                                                    <tr>
                                                                ...
                                                                &nbsp;
<fieldset  style="border-width:medium;padding-bottom:15px">
    <legend style="font-weight:bold">Danh Sách Bệnh Nhân - Tạm Ứng</legend>
                                                    <asp:datagrid id="dgr" runat="server" width="100%" allowsorting="True"
...
<asp:TemplateColumn><ItemTemplate>
<asp:LinkButton id="lnbtnMauTH" Text="Mẫu TH" runat="server"  CommandName="ViewMauTH" CommandArgument='<%# Eval("idchitietdangkykham") %>'></asp:LinkButton> 
</ItemTemplate>
<HeaderStyle Width="5%"></HeaderStyle>
</asp:TemplateColumn>
...
<asp:TemplateColumn><ItemTemplate>
<asp:LinkButton id="lnbtnCTTU" Text='<%#Eval("CTTamUng") %>'  runat="server"  CssClass="alink3" CommandName="LichSu" CommandArgument='<%# Eval("idchitietdangkykham") %>'></asp:LinkButton> 
</ItemTemplate>
...
<HeaderStyle Wrap="False" Width="11%"></HeaderStyle>
...
<asp:BoundColumn DataField="Phongkham" HeaderText="Phòng khám"></asp:BoundColumn>
<asp:BoundColumn DataField="ngayvaovien" HeaderText="Ngày vào viện"  DataFormatString="{0:dd/MM/yyyy HH:mm}" ></asp:BoundColumn>
<asp:BoundColumn DataField="TongTienXetChoTU" DataFormatString="{0:N0}"  HeaderText="Tổng tiền tạm ứng"></asp:BoundColumn>
<%--<asp:BoundColumn DataField="TongSoTien"  DataFormatString="{0:N0}"  HeaderText="Tổng tiền viện phí"></asp:BoundColumn>
<asp:BoundColumn DataField="SoTienDaDong" DataFormatString="{0:N0}"  HeaderText="Số tiền đ&#227; đ&#243;ng"></asp:BoundColumn>
<asp:BoundColumn DataField="TUConLai" DataFormatString="{0:N0}"  HeaderText="Tạm ứng còn lại"></asp:BoundColumn>--%>
<%--<asp:BoundColumn DataField="SoTienBNPhaiTra1" DataFormatString="{0:N0}"  HeaderText="Số tiền BN phải trả"></asp:BoundColumn>--%>
</Columns>

<HeaderStyle HorizontalAlign="Center" BackColor="#CAE3FF" CssClass="dgrHeader" Font-Bold="True" ForeColor="Blue"></HeaderStyle>
</asp:datagrid>
        </fieldset>
</td>
                                                        </tr>
