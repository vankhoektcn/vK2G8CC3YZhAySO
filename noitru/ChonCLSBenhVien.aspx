<%@ Page Language="C#" MasterPageFile="~/MasterPage_New.master" AutoEventWireup="true" CodeFile="ChonCLSBenhVien.aspx.cs" Inherits="noitru_ChonCLSBenhVien" Title="" %>
<asp:Content ID="Content1" ContentPlaceHolderID="header" Runat="Server">
</asp:Content>    
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    <div class="headerChiDinhK-div" >Chỉ định dịch vụ</div>
    ...
    <input id="Button1" type="button" runat="server" value="Chỉ định CLS"  onclick="BeforeChonCLSClick();CLSChonClick();" style="width:100px"  /><br /><br /> <%--style="margin-top:100px"--%>
...
//	        if( event.keyCode == 13 || enter != null)// || event.keyCode == 9
//	        {
//	            var maBenhNhan=obj;
//	            var PathUrl="../ajax/khambenh_ajax3.aspx?do=TimKiemBenhNhanTheoMaBenhNhan&MaBenhNhan="+maBenhNhan+"&IdKhoaNoiTru="+$.mkv.queryString("IdKhoa")+"";
//	            if(timTheoMa== 0)   
//	               {//alert("Tìm theo tên !");return;
//	                  var tenbenhnhan= document.getElementById('<%=txtTenBenhNhan.ClientID %>').value;
//	                  PathUrl="../ajax/khambenh_ajax3.aspx?do=TimKiemBenhNhanTheoTenBenhNhan&TenBenhNhan="+encodeURIComponent(tenbenhnhan)+"&IdKhoaNoiTru="+$.mkv.queryString("IdKhoa")+"";
//	               }
//	            $.ajax
...
//                                
//                                document.getElementById('<%=Button1.ClientID %>').style.display='';//Hiện nút chọn ChiDinh CLS                                
