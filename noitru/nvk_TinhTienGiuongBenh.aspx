<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nvk_TinhTienGiuongBenh.aspx.cs" Inherits="nvk_TinhTienGiuongBenh" %>
...
function ThongTinBenhNhan()
{
    ...
    var idkhoa= $.mkv.queryString("IdKhoa");
	        ...
	        var PathUrl="../ajax/nvk_khamTongHop_ajax.aspx?do=SetBenhNhanCongNo&idbenhnhan="+idbn+"&idctdkk="+idchitietdangkykham+"&IdKhoaNoiTru="+idkhoa+"";	            
	        $.ajax
	            ({
                     type:"GET",
                     cache:false,
                      ...
                      success: function (value)
                        {
                            ...
                            //alert("idbn="+idbn+"; idchitietdangkykham="+idchitietdangkykham+"; value="+value);
	                            ...
	                            loadChiTietTinhGiuongBenhNhan(idbn,idchitietdangkykham,idkhoa,0);
                        }
                });
 }
