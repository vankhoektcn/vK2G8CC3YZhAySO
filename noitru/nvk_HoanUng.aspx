<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nvk_HoanUng.aspx.cs"
    Inherits="nvk_HoanUng" %>
...
function btnTimKiem_click()
{
    ...
    {
        alert("Chưa nhập thông tin bệnh nhân !");return;
    }
        $("#divDanhSachBN").html("<span style='height: auto; width: 100%;text-align:center; color: Red; font-weight: bold;font-style:italic' class='Tieude'> Đang load bệnh nhân.....<img id='imgLoading' src='../images/processing.gif' /></span>");
        var PathUrl="../ajax/nvk_HoanUng_ajax.aspx?do=btnTimKiem_click&idkhoa="+queryString("IdKhoa")+"&mabenhnhan="+$("#txtmabenhnhan").val()+"&tenbenhnhan="+encodeURIComponent($("#txttenbenhnhan").val());//+"&tungay="+$("#txtTuNgay").val()+"&denngay="+$("#txtDenNgay").val()+"";	            
	        $.ajax
	            ({
                     type:"GET",
                     cache:false,
...
{
//    $(obj).TimKiem({
//        ajax:"../ajax/nvk_HoanUng_ajax.aspx?do=TienGiuong_Click&idkhoa="+queryString("IdKhoa")+"&idctdkk="+idchitietdangkykham+"&idbenhnhan="+idbenhnhan+"&ngaynhap="+ngaynhap+"&tenphong="+tenphong+""
//        ,title:"Bệnh Nhân - Tiền Giường"
//    },null,null,function(){});
    var divG=document.getElementById("nvkDivGFather");
        divG.style.display="block";                            
        $("#nvk_divChua").html("<span style='height: auto; width: 100%;text-align:center; color: Red; font-weight: bold;font-style:italic' class='Tieude'> Đang load .....<img id='imgLoading' src='../images/processing.gif' /></span>");
        var PathUrl="../ajax/nvk_HoanUng_ajax.aspx?do=TienGiuong_Click&idkhoa="+queryString("IdKhoa")+"&idctdkk="+idchitietdangkykham+""
    $.ajax
	            ({
                     type:"GET",
                     cache:false,
        ...
        <fieldset class="fieldset_Father">
            <div id="divTK1" class="divControl">
                <fieldset class="fieldset_CT">
                    ...
                    <input mkv="true" id="txttenbenhnhan" type="text" style="width: 300px" />
...
<span class="spanText">Năm sinh:</span> <input type="text" id="namsinh" style="width: 80px;" />--%>
            ...
            <div class="divContent">
                <fieldset class="fieldset_ND">
                        <legend class="legend_ND">Danh Sách Bệnh Nhân - Hoàn Ứng</legend>
    ...
    <div style="display:none;position:fixed;top:15%;bottom:10%;left:10%;width:80%;height:430px;background-color:White;z-index:1000;padding:10px 10px 10px 10px;border:10px solid #4D67A2;overflow-y:visible;" id="nvkDivGFather" >
        <div style="width:100%;height:25px;background: url(../images/bgmenu.gif) repeat;">
            <span align="left" style="float:left;padding-top:2px;padding-left:10px;cursor:pointer;font-weight:bold;" onmousedown="mouseDown('nvkDivGFather')" onmouseup="mouseRelease()">Thông Tin Bệnh Nhân Hoàn Ứng</span>
            <span style="float:right"><img src="../images/close.gif" align="right" style="width:25px;height:25px;cursor:pointer;" title="click vào để đóng danh sách" onclick="hideDivG_BN('nvkDivGFather')" ></span>
        </div>
        <div id="nvk_divChua" style="width:100%;height:400px !inportant;overflow-y:scroll;float:right">
        
        </div>
    </div>
    <%--<a onclick="javascript:alert('dfgf');" style="cursor:pointer;color:Blue;text-underline-position:below;">dfdsdsd</a>--%>
    <%--fgfjkfk--%>
</form>
