<%@ Page Language="C#" MasterPageFile="~/MasterPage_New.master" AutoEventWireup="true" CodeFile="ChonThuocBenhVien.aspx.cs" Inherits="noitru_ChonThuocBenhVien" Title="Khoa sản" %>
<asp:Content ID="Content1" ContentPlaceHolderID="header" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    <div class="headerChiDinhK-div" >Chỉ định thuốc, VTYT</div>
    <div id="ThuocChonClick-div" style="display:none;background:#D4D0C8;position:fixed;width:100%;top:100;left:0;right:0;bottom:0;z-index:99999;height:100%;overflow:auto;padding-top:200px">
    ...
    <input id="Button1" type="button" runat="server" value="Chỉ định Thuốc"  onclick="BeforeChonCLSClick();ThuocChonClick();" style="width:100px"  /><br /><br /> <%--style="margin-top:100px"--%>
    ...
    <div style="display:none;position:fixed;top:15%;left:10%;width:80%;background-color:White;z-index:1000;padding:10px 10px 10px 10px;border:10px solid #4D67A2" id="divDanhSachBN" runat="server">
    ...
    window.onload=function ()
    {
        ...
        {
//            var mabenhnhan=$.mkv.queryString("MaBenhNhan");
//	          var tenbenhnhan='';
//	            $(document.getElementById('<%=Button2.ClientID %>')).TimKiem({
...
//                });
        ...
        function ThuocChonClick(){
            var fileascx = "~/usercontrols/ThuocChon.ascx";
                if($.mkv.queryString("IsTheoDoiCC")=="1" || $.mkv.queryString("load") == '1' || $.mkv.queryString('IdKhoa')=="15")
                fileascx = "~/usercontrols/ThuocChonTheoDoiCC.ascx";
	    ...
	    {
	          var idbenhnhan= document.getElementById('<%=hdIdBenhNhan.ClientID %>').value;
	            $(obj).TimKiem({
	    ...
	    function SetBenhNhanClick(MaBenhNhan,IdKhoa)
	    {
	        var ngayLoc= document.getElementById('<%=ngayLoc.ClientID %>').value;
	            var PathUrl="../ajax/khambenh_ajax3.aspx?do=SetBenhNhanClick&MaBenhNhan="+MaBenhNhan+"&IdKhoaNoiTru="+$.mkv.queryString("IdKhoa")+"&isThuoc=1"+"&ngayLoc="+ngayLoc+"";;	            
	        $.ajax
	            ({
                     type:"GET",
                     cache:false,
