...
function An(id,isAn,isUseDangLuu)
	{
	    ...
	    {        
	        if(isAn){
	           ...
	           if(isUseDangLuu)
	            document.getElementById('dangluu').style.display='';
	        }
	        else {obj.style.display='';
	            if(isUseDangLuu)
	                document.getElementById('dangluu').style.display='none';
	        }
	    }
...
function createTip(td,divname,divchildname,title,ajaxname,sloganajax,error,url, wid, hei)
{
    try
   {
        ...
        else     div.style.width = wid + "px";
        if(hei=='auto')
            div.style.height ='auto';
        else  div.style.height = hei + "px";
...
//===========================================
function createTipOption(td,divname,divchildname,title,ajaxname,sloganajax,error,url, wid, hei,posX,posY)
{
    try
   {
        hideTip(divname);
        ...
        //var posX = posX;//200;//e.clientX;
        //var posY = posY;//100;//e.clientY;
        div.style.top = _parseInt(posY) ;//+ 20;
        div.style.left = _parseInt(posX);// - 100;
        td.appendChild(div);
        createTable(divname,divchildname,title,ajaxname,sloganajax,error,url, wid, hei);
...
function createTipTU(td,divname,divchildname,title,ajaxname,sloganajax,error,url, wid, hei,viTriX,viTriY)
{
    try
   {
        hideTip(divname);
        ...
        if(viTriY != null)
            posY= viTriY;
        div.style.top = _parseInt(posY) ;
        div.style.left = _parseInt(posX) ;
        td.appendChild(div);
...
function createTableTU(divname,divchildname,title,ajaxname,sloganajax,error,url, wid, hei)
{
    try
    {
        ...
        td.style.background="url(../images/header.gif) repeat-x";
    ...
    xmlHttp.onreadystatechange = function()
    {
        if(xmlHttp.readyState == 4)
        {
            ...
            else 
            {
                var div = document.getElementById(divchildname);
                div.innerHTML = value;
                if(idFocus!=null && idFocus!='' && idFocus!='undefined')
                {
                document.getElementById(idFocus).focus();
                }
                var divLuuCLS=document.getElementById('divLuuCLS');
                if(divLuuCLS!=null && divLuuCLS!='undefined')
                    divLuuCLS.style.display='';
                var showKQ=document.getElementById('showKQ');
                if(showKQ!=null && showKQ!='undefined')
	                showKQ.focus();
            }
        }
    }
...
function OpenPhieuThu()
{
    ...
    var obj = new Object();
        obj = window.showModalDialog("rptInPhieuThu.aspx?mabn="+obj1.value+"&cpu="+queryString("cpu")+"&tenbn="+myEscape(obj2.value)+"&diachi="+myEscape(obj3.value)+"&sotien="+obj4.value+"&noidung="+myEscape(obj5.value)+"&ngaythu="+obj6.value+"&cpu="+queryString("cpu")+"&times="+Math.random(),"","DialogWidth:800px;DialogHeight:500px;overflow:hidden;");
    window.Open("");
}
...
{
    var obj = new Object();
        obj = window.showModalDialog("rptInPhieuThuNhapKham.aspx?maphieu="+maphieuthu+"&cpu="+queryString("cpu")+"&times="+Math.random(),"","DialogWidth:800px;DialogHeight:500px;overflow:hidden;");
    window.Open("");
}
...
{
    var obj = new Object();
        obj = window.showModalDialog("rptInPhieuThuKhamBenh.aspx?maphieu="+maphieuthu+"&cpu="+queryString("cpu")+"&times="+Math.random(),"","DialogWidth:800px;DialogHeight:500px;overflow:hidden;");
    window.Open("");
}
...
function TaoToaThuoc(mabenhnhanphongkham)
{
    ...
    xmlHttp.onreadystatechange = function()
    {
        if(xmlHttp.readyState == 4)
        {
            ...
            {     
                var obj = new Object();
                obj = window.showModalDialog("toathuocbenhnhanentry.aspx?mabenhnhanphongkham="+mabenhnhanphongkham+"&cpu="+queryString("cpu")+"&times="+Math.random(),"","DialogWidth:850;DialogHeight:400;overflow:auto;");
                window.Open("");
            }
            else
            {
    ...
    xmlHttp.open("GET","ajax.aspx?do=checkpermission&idbenhnhanphongkhambenh=" + mabenhnhanphongkham+"&cpu="+queryString("cpu") + "&times="+Math.random(),true);
    xmlHttp.send(null);
}
...
{
    var obj = new Object();
        obj = window.showModalDialog("rptInPhieuThuKhamBenh.aspx?mabenhnhanphongkham="+mabenhnhanphongkham+"&cpu="+queryString("cpu")+"&times="+Math.random(),"","DialogWidth:800px;DialogHeight:500px;overflow:hidden;");
    window.Open("");
}
...
function InPhieuThuCanLamSan(mathutien)
{
    ...
    action.value = "";
    var obj = new Object();
        obj = window.showModalDialog("rptInPhieuThuKhamBenh.aspx?maphieu="+mathutien+"&cpu="+queryString("cpu")+"&times="+Math.random(),"","DialogWidth:800px;DialogHeight:500px;overflow:hidden;");
    window.Open("");
    return;
}
...
{
    var obj = new Object();
        obj = window.showModalDialog("rptintoathuocbenhnhan.aspx?mabenhnhanphongkham="+idbenhnhanphongkhambenh+"&cpu="+queryString("cpu")+"&times="+Math.random(),"","DialogWidth:800px;DialogHeight:500px;overflow:hidden;");
    window.Open("");
    return;
}
