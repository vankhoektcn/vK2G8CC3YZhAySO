<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="frp_ThongKeTienCLS.aspx.cs" Inherits="frp_ThongKeTienCLS" %>
<%@ Register Assembly="System.Web.Extensions, Version=1.0.61025.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35"
    Namespace="System.Web.UI" TagPrefix="asp" %>

<%@ Register Src="~/VienPhi_TH/uscmenu.ascx" TagName="uscmenu" TagPrefix="uc3" %>
				    ...
				    <tr>
				        <td class="title" colspan = "2" align = "center" style="background-color: #4D67A2; height: 19px;">
					        <p class="title" style ="color:#FFFFFF">
                                BÁO CÁO TIỀN CẬN LÂM SÀN ĐÃ THU</p>
				        </td>
			        </tr>
				    <TR>
					    <TD width="100%">
													   ...
													   <tr style="text-align:left">	
				                                        ...
				                                        <tr style="text-align:left">
                                                            ...
                                                            <asp:scriptmanager runat="server" id="ScriptM">
                                                             ...
                                                             <ContentTemplate> 
                                                                &nbsp;Khoa phòng
                                                                <asp:dropdownlist id="ddlPhongKhoa" runat="server"  AutoPostback="True" 
                                                                    width="189px"></asp:dropdownlist>&nbsp;Cận lâm sàn &nbsp;<asp:dropdownlist id="ddlCLS" runat="server" autopostback="True"
                                                                    width="189px"></asp:dropdownlist>
                                                                &nbsp;Loại:<asp:dropdownlist id="ddPhongSo" runat="server" Width="226px"  AutoPostback="True"><asp:ListItem Value="0">--Tất cả--</asp:ListItem>
                                                                    <asp:ListItem Value="1">Do b&#225;c sĩ chỉ định</asp:ListItem>
                                                                    <asp:ListItem Value="2">Bệnh nh&#226;n tự đăng k&#253;</asp:ListItem> </asp:dropdownlist>
				                                           </ContentTemplate>
                                                        </asp:updatepanel>				                                            
				                                            </td>				                                           
				                                        </tr>
