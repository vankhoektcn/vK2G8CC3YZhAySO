<%@ Page Language="C#" MasterPageFile="~/VienPhi_TH/MasterPage.master" AutoEventWireup="true"
    CodeFile="frm_DSBNTraTienPhiKham.aspx.cs" Inherits="VienPhi_TH_frm_DSBNTraTienCLS"
    Title="Danh sách BN Trả Phí Khám + Tiền sổ" %>

<asp:Content ID="Content1" ContentPlaceHolderID="header" runat="Server">

    <script type="text/javascript" src="javascript/DSBNTraTienPhiKham.js"></script>

</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="body-div">
        <p class="header-div">
            <%=hsLibrary.clDictionaryDB.sGetValueLanguage("DANH SÁCH BỆNH NHÂN TRẢ TIỀN PHÍ KHÁM")%>
        </p>
        <div class="in-a">
            <div class="div-Out">
                <h4>
