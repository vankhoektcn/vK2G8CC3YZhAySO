<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HDDV_rptXuatHoaDonBanHang.aspx.cs" Inherits="ketoan_HDDV_rptXuatHoaDonBanHang" %>
...
<table cellpadding = "0" cellspacing = "0" border = "0" width = "100%" >
    <tr>
        <td align = "left" valign = "top" style="height: 34px" bgcolor = "#EAEBE6">
            <uc1:menu_ketoanhoadonDV ID="menu_ketoanhoadonDV1" runat="server" />
        </td>
    </tr>
    <tr>
			    ...
			    <table id="user" cellSpacing="1" cellPadding="1" width="100%" border="0" class = "khung">
				    <tr>
				        <td class="title" align = "center" style ="background-color: #4D67A2">
			                <span class="title" style ="color:#FFFFFF">IN HÓA ĐƠN DỊCH VỤ</span></td>
				    </tr>
				    <TR>
					    <TD width="100%">
					    </TD>
