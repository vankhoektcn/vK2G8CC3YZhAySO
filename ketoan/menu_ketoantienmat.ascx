<%@ Control Language="C#" AutoEventWireup="true" CodeFile="menu_ketoantienmat.ascx.cs" Inherits="menu_ketoantienmat" %>
<asp:Menu ID="Menu1" runat="server" DynamicEnableDefaultPopOutImage="False" Font-Bold="True" Font-Names="Arial" Font-Size="Small" ItemWrap="True" Orientation="Horizontal" Height = "21px" StaticEnableDefaultPopOutImage="False" ForeColor="White">
    <Items>
        ...
        <asp:MenuItem  Text="Thu/chi hóa đơn" Value="m_thuchihd">
            <asp:MenuItem  ImageUrl="~/nhanbenh/images/nut.jpg"  NavigateUrl="~/ketoan/KTTM_PhieuThuHoaDon.aspx" Text="&#160;&#160;Thu hóa đơn&#160;&#160;" Value="Thu chi hóa đơn"></asp:MenuItem>
            <asp:MenuItem  ImageUrl="~/nhanbenh/images/nut.jpg"  NavigateUrl="~/ketoan/KTTM_PhieuChiHoaDon.aspx" Text="&#160;&#160;Chi hóa đơn&#160;&#160;" Value="Thu chi hóa đơn"></asp:MenuItem>
