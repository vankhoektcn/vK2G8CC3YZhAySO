<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KTNH_SoTienGoiNganHang.aspx.cs" Inherits="SoTienGoiNganHang" %>
...
<%--<%@ Register Src="menu_ketoannganhang.ascx" TagName="menu_ketoannganhang" TagPrefix="uc2" %>
--%>
...
<table cellpadding = "0" cellspacing = "0" border = "0" width = "100%" >
    <tr>
        <td align = "left" valign = "top" style="height: 34px" bgcolor = "#EAEBE6">
            <uc1:menu_ketoannganhang ID="menu_ketoannganhang" runat="server" />
        </td>
    </tr>
    <tr>
			    ...
			    <table id="user" cellSpacing="1" cellPadding="1" width="100%" border="0" class = "khung">
				    <tr>
				        <td class="title" align = "center" style ="background-color: #4D67A2">
			                <span class="title" style ="color:#FFFFFF">SỔ TIỀN GỞI NGÂN HÀNG</span></td>
				    </tr>
				    <TR>
					    <TD width="100%">
                            Từ ngày:
                            ...
                            &nbsp;Tài khoản:
                            <asp:dropdownlist id="drltknganhang" runat="server"> </asp:dropdownlist>
