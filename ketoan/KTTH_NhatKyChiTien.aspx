<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KTTH_NhatKyChiTien.aspx.cs" Inherits="ketoan_KTTH_NhatKyChiTien" %>

<%@ Register Src="~/ketoan/Menu_KT/uscmenuKT_TongHop.ascx" TagName="uscmenuKT_TongHopNKCT" TagPrefix="uc1" %>
...
<table cellpadding = "0" cellspacing = "0" border = "0" width = "100%" >   
     <tr>
        <td width = "100%" align = "left" class="bg_menu">
            <uc1:uscmenuKT_TongHopNKCT ID="uscmenuKT_TongHopNKCT1" runat="server" />
        </td>
    </tr>
    <tr>
			    ...
			    <table id="user" cellSpacing="1" cellPadding="1" width="100%" border="0" class = "khung">
				    <tr>
				        <td class="title" align = "center" style ="background-color: #4D67A2">
			                <span class="title" style ="color:#FFFFFF">NHẬT KÝ CHI TIỀN </span></td>
				    </tr>
				    <TR>
					    <TD width="100%" style="height: 27px">
                            ...
                            <asp:dropdownlist id="ddl_tk" runat="server" width="150"></asp:dropdownlist>
