<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BaoCaoVATDauRa.aspx.cs" Inherits="BaoCaoVATDauRa" %>
			    ...
			    <table id="user" cellSpacing="1" cellPadding="1" width="100%" border="0" class = "khung">
				    <tr>
				        <td class="title" align = "center" style ="background-color: #4D67A2">
			                <span class="title" style ="color:#FFFFFF">BÁO CÁO VAT ĐẦU RA</span></td>
				    </tr>
				    <TR>
					    <TD width="100%">
                            Tháng:&nbsp;
