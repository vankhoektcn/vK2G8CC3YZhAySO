<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KTCN_Khach_Hang_CT.aspx.cs" Inherits="KTCN_KhachHang_CT" %>
...
//    var thang = document.getElementsByTagName("option")[index].value;
    ...
    {          
             var objsrc = document.getElementById(obj);                        
                $("#"+obj).unautocomplete().autocomplete("ajax.aspx?do=LoadDanhSachKhachHang_CongNo&Key="+encodeURIComponent(objsrc.value)+"&obj="+obj,
			    ...
			    <table id="user" cellSpacing="1" cellPadding="1" width="100%" border="0" class = "khung">
				    <tr>
				        <td class="title" align = "center" style ="background-color: #4D67A2">
			                <span class="title" style ="color:#FFFFFF">CÔNG NỢ KHÁCH HÀNG CHI TIẾT</span></td>
				    </tr>
				    <TR>
					    <TD width="100%">
                            Từ ngày:
                            ...
                            &nbsp;Mã KH:
                            <%--<select id="ddl_MaKH" style="width:150px" runat="server" onchange="ddlMaKhachHang_select()">                                
                                <option value="0">Khách hàng</option>
                                <option value="1">Bệnh nhân</option>
                            </select>    --%>                         
                            <asp:textbox id="txtMaKH" runat="server" height="20px" onfocus="ShowKhachHang('txtMaKH')" tabindex="2" width="149px"></asp:textbox>                                                      
