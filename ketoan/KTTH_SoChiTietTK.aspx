<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KTTH_SoChiTietTK.aspx.cs" Inherits="KTTH_SoChiTietTK" %>
<%@ Register Src="~/ketoan/Menu_KT/uscmenuKT_TongHop.ascx" TagName="uscmenuKT_TongHopSCTTK" TagPrefix="uc1" %>
...
<table cellpadding = "0" cellspacing = "0" border = "0" width = "100%" >   
    <tr>
        <td width = "100%" align = "left" class="bg_menu">
            <uc1:uscmenuKT_TongHopSCTTK ID="uscmenuKT_TongHopSCTTK1" runat="server" />
        </td>
    </tr> 
    <tr>
			    ...
			    <table id="user" cellSpacing="1" cellPadding="1" width="100%" border="0" class = "khung">
				    <tr>
				        <td class="title" align = "center" style ="background-color: #4D67A2">
			                <span class="title" style ="color:#FFFFFF">SỔ CHI TIẾT TÀI KHOẢN</span></td>
				    </tr>
				    <TR>
					    <TD width="100%">
                            Từ ngày:
