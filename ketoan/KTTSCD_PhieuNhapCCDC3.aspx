<%@ Page Language="C#" MasterPageFile="~/ketoan/MasterPage_KT.master" AutoEventWireup="true"
    CodeFile="KTTSCD_PhieuNhapCCDC3.aspx.cs" Inherits="ketoan_KTTSCD_PhieuNhapCCDC3" %>

<%@ Register Src="Menu_KT/uscmenuKT_CCDC.ascx" TagName="uscmenuKT_TaiSan" TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="header" runat="Server">

    <script type="text/javascript" src="javascript/KTTSCD_PhieuNhapCCDC3.js">
    </script>
...
<uc1:uscmenuKT_TaiSan ID="UscmenuKT_TaiSan1" runat="server" />
    <div class="body-div">
        <div class="header-div">
            <%=hsLibrary.clDictionaryDB.sGetValueLanguage("Phiếu Nhập Công Cụ Dụng Cụ")%>
        </div>
        <div class="in-a">
            <div class="div-Out">
                <div class="div-Left">
            ...
            <div class="div-Out">
                ...
                <div class="div-Right">
                    <input mkv="true" id="diachi_ncc" type="text" onfocus="Find(this);chuyenphim(this);"
                        style="width: 90%" />
                </div>
            </div>
            <div class="div-Out">
            ...
            <div class="div-Out">
                ...
                <div class="div-Right">
                    ...
                    <input mkv="true" id="mkv_loai_nt" type="text" onfocus="Find(this);chuyenphim(this);ngoaiteSearch(this);"
            ...
            <div class="div-Out">
                ...
                <div class="div-Right">
                    <input mkv="true" id="ty_gia" type="text" onfocus="Find(this);chuyenphim(this);"
                         style="width: 90%" />
                </div>
            </div>
            <div class="div-Out">
                ...
                <div class="div-Right">
                    <input mkv="true" id="id_loaiphi" type="hidden" onfocus="Find(this);chuyenphim(this);" />
                    <input mkv="true" id="mkv_id_loaiphi" type="text" onfocus="Find(this);chuyenphim(this);loaiphiSearch(this);"
                        onblur="" style="width: 90%" class="down_select" />
                </div>
            </div>
            <div class="div-Out">
        ...
        <div align="right">
            <table>
                <tr>
                    ...
                    <td>
                        <b>Tổng Chiết khấu:</b><input type="text" style="text-align:right" id="txtchietkhau" onblur='' style="width: 50px;" /></td>
                    <td>
                    </td>
                    <td>
                        <b>Tổng Tiền thuế:</b><input type="text" style="text-align:right" id="txttienthue" onblur='tinhtien(this);' /></td>
                    <td>
                    </td>
                    <td>
                        <b>Tổng tiền:</b><input id="txtthanhtien" style="text-align:right" type="text" onfocus="Find(this);chuyenphim(this);"
    ...
    <div class="body-div-button">
        <div class="in-a">
            <input id="luu" type="button" edit="<%=StaticData.HavePermision(this, "KeToanCCDC_KTTSCD_PhieuNhapCCDC3_Sua") %>"
                add="<%=StaticData.HavePermision(this, "KeToanCCDC_KTTSCD_PhieuNhapCCDC3_Them") %>"
