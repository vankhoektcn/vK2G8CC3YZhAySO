<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KTVT_DM_Vat_Tu.aspx.cs" Inherits="DM_Vat_Tu_KT" %>
...
<table border="0" cellpadding="1" cellspacing="1" width="100%" id="user1" style ="background-color: #C0C0C0">
    ...
    <tr>
        <td class="title" width="100%"><img src="../images/customer.gif" border="0" align="absmiddle">&nbsp;DANH MỤC TÀI SẢN<p>
            </p></td>
    </tr>
   <tr>
       <td width="100%" id="chitietkho">
            <table border="0" cellpadding="1" cellspacing="1" width="100%" id="user1">
                <tr>
                    <td colspan="6" class="header" bgcolor="#3F86F8">Thêm hoặc cập nhật thông tin tài sản</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td width="10%" class="tieude">Mã tài sản (&nbsp;<font color="red">*</font>&nbsp;)&nbsp;: </td>
                    ...
                    <td width="10%" class="tieude">Tên tài sản (&nbsp;<font color="red">*</font>&nbsp;)&nbsp;: </td>
                    <td width="30%">
...
<asp:BoundColumn DataField="ma_vt" HeaderText="Mã TS/CCDC">
<ItemStyle Wrap="False"></ItemStyle>
<HeaderStyle Width="10%" Wrap="False"></HeaderStyle>
</asp:BoundColumn>

<asp:BoundColumn DataField="ten_vt" HeaderText="Tên TS/CCDC">
<ItemStyle Wrap="False"></ItemStyle>
