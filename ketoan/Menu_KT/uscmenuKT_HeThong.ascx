...
<asp:Menu ID="Menu1" BackColor="#FBF8F1" AccessKey="M" runat="server" DynamicEnableDefaultPopOutImage="false" Orientation="Horizontal" DynamicVerticalOffset="2"  StaticEnableDefaultPopOutImage="False">
    <Items>
        ...
        <asp:MenuItem Text="Khai Báo Tham Số Hệ Thống " Value="khaibaothamsohethong">
                <asp:MenuItem  ImageUrl="~/nhanbenh/images/nut.jpg" NavigateUrl="~/ketoan/KTHT_ThamSoTuyChon.aspx" Text="Danh Sách Tham Số Tùy Chọn" Value="dsthamsotuychon"></asp:MenuItem>
       ...
       <%--danh muc--%>
        ...
        <%--baocao--%>
         <asp:MenuItem Text="Cập Nhật Số Dư Dầu Kỳ" Value="Bao cao"> 
                ...
                <asp:MenuItem  ImageUrl="~/nhanbenh/images/nut.jpg" NavigateUrl="~/ketoan/KTHT_Sodudaukytaikhoan2.aspx" Text="Số Dư Đầu Kỳ Tài Khoản " Value="sodudaukytaikhoan"></asp:MenuItem>
        
                <asp:MenuItem  ImageUrl="~/nhanbenh/images/nut.jpg" NavigateUrl="~/ketoan/KTHT_CongNo_DauKi2.aspx" Text="Công Nợ Đầu Kỳ" Value="congnodauky"></asp:MenuItem>
