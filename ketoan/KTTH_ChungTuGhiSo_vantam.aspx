<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KTTH_ChungTuGhiSo_vantam.aspx.cs" Inherits="KTTH_ChungTuGhiSo" %>
			    ...
			    <table id="user" cellSpacing="1" cellPadding="1" width="100%" border="0" class = "khung">
				    <tr>
				        <td class="title" align = "center" style ="background-color: #4D67A2">
			                <span class="title" style ="color:#FFFFFF">CHỨNG TỪ GHI SỔ</span></td>
				    </tr>
				    <TR>
					    <TD width="100%">
                            Từ ngày:
                            ...
                            &nbsp;Tài khoản có:
                            <asp:textbox id="txtTaiKhoanCo" runat="server" height="20px" tabindex="2" width="104px" onfocus="ShowTaiKhoan(this);"></asp:textbox>
