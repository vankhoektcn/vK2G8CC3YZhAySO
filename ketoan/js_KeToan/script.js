...
function loadDanhSachHangSanXuat2(mahangsanxuat)
{
    try
    {
        var span = document.getElementById("ajaxdanhmuckho");
        span.style.display = "";
        loadChiTietHangSanXuat2(mahangsanxuat);
    }
    catch(exception)
    {
    }
...
function loadChiTietHangSanXuat2(mahang)
{
    xmlHttp = GetMSXmlHttp();
    xmlHttp.onreadystatechange = function()
    {
    ...
    xmlHttp.open("GET","ajax.aspx?do=loadchitiethangsanxuat2&mahang="+mahang+"&times="+Math.random(),true);
    xmlHttp.send(null);
}
