...
function createTip(td,divname,divchildname,title,ajaxname,sloganajax,error,url, wid, hei)
{
    try
   {
        ...
        var posX = 300;//e.clientX;
        var posY = 300;//e.clientY;
...
//                LoadInfoThuoc(sVT);
    ...
    function DoActionPhieuNhap()
    {
        ...
        if(keycode == 9) // Phim Tab
        {
            ...
            else
            {
               ...
               {
                     LuuChiTietPhieuNhap(omavt.value,osoluong.value,odongia.value,ochietkhau.value,ovat.value,olosx.value, ongayhethan.value, othuenk.value, oloaitien.value, otygia.value);
    ...
    function LuuChiTietPhieuNhap(omavt,osoluong,odongia,ochietkhau,ovat,olosx,ongayhethan,othuenk,oloaitien,otygia)
    {
        ...
        xmlHttp.open("GET","ajax.aspx?do=luuctphieunhap&mavt="+omavt+"&soluong="+osoluong+"&dongia="+odongia+"&chietkhau="+ochietkhau+"&vat="+ovat+"&losx="+olosx+"&ngayhethan="+ongayhethan+"&thuenk="+othuenk+"&loaitien="+oloaitien+"&tygia="+otygia+"&times="+Math.random(),true);
        xmlHttp.send(null);
    }
    ...
    function DoActionPhieuXuat(e)      //function DoActionPhieuXuat(e)
    {
        ...
        if(keycode == 13)
        {
            if (opxid.value == "-1")
            {
                ...
                var oDienGiai = document.getElementById("txtDienGiai");
                var oKho = document.getElementById("ddlKho"); 
                var oBophan = document.getElementById("ddlncc"); //ddlbophan
        ...
        if(keycode == 9) // Phim Tab
        {
            ...
            if (opxid.value == "-1")
            {
                ...
                var oDienGiai = document.getElementById("txtDienGiai"); 
                var oKho = document.getElementById("ddlKho"); 
                var oBophan = document.getElementById("ddlncc"); 
                var oNguoinhan = document.getElementById("txtnguoinhan"); 
                var oXuatcho = document.getElementById("ddlnhapcho"); 
                var omavt = document.getElementById("ddlVatTu"); 
                var osoluong = document.getElementById("txtSoLuong"); 
...
//            return false;
        ...
        if (oNguoinhan.value == "")
        {
//            alert("Bạn chưa chọn người nhận. Vui lòng kiểm tra lại.");
//            oNguoinhan.focus();
//            return false;
        }
    ...
    function CheckThongTinCTPhieuXuat(omavt,osoluong)
    {
        if (omavt.value == "0")
        {
            alert("Bạn chưa nhập tên sản phẩm. Vui lòng kiểm tra lại.");
            omavt.focus();
            return;
        }
        if (osoluong.value == "0")
    ...
    function LuuPhieuXuat(oSoCt, oNgayCt, oDienGiai, oKho, oBophan, oNguoinhan, oXuatcho, omavt, osoluong)
    {
        ...
        var ock=document.getElementById("txtchietkhau");
        
        var stkno=document.getElementById("tkno");
        var stkco=document.getElementById("tkco");
        var stkvat=document.getElementById("tkvat");
        
        var skyhieuhd=document.getElementById("txtKyHieuHD");
        var ssohd=document.getElementById("txtSoHD");
        var sngayhd=document.getElementById("txtNgayHD");
        ...
        xmlHttp.open("GET","../QuanLySieuThi/ajax.aspx?do=luuphieuxuat&soct="+oSoCt+"&ngayct="+oNgayCt+"&diengiai="+encodeURIComponent(oDienGiai)+"&kho=" + oKho + "&bophan=" + oBophan + "&nguoinhan=" + encodeURIComponent(oNguoinhan) + "&loaixuat=" + oXuatcho +"&mavt="+omavt+"&soluong="+osoluong+"&chietkhau="+ock.value+"&tkno="+stkno.value+"&tkco="+stkco.value+"&tkvat="+stkvat.value+"&kyhieuhd="+skyhieuhd.value+"&sohd="+ssohd.value+"&ngayhd="+sngayhd.value+"&times="+Math.random(),true);
        xmlHttp.send(null);
    }
    function LuuChiTietPhieuXuat(omavt,osoluong)
    {
        ...
        xmlHttp.onreadystatechange = function()
        {
            if(xmlHttp.readyState == 4)
            {
                ...
                if (value == "3")
                {
                    alert("Số lượng tồn không đủ để xuất!")
                    return;
                }
            }
        }
        xmlHttp.open("GET","../QuanLySieuThi/ajax.aspx?do=luuctphieuxuat&mavt="+omavt+"&soluong="+osoluong+"&chietkhau="+ock.value+"&loaixuat="+oXuatcho.value+"&bophan="+obophan.value+"&times="+Math.random(),true);
        xmlHttp.send(null);
    }
	
    function LoadChiTietPhieuXuat()
    {
        var oKho = document.getElementById("ddlKho").value; 
        xmlHttp = GetMSXmlHttp();
        xmlHttp.onreadystatechange = function()
        {
            if(xmlHttp.readyState == 4)
        ...
        xmlHttp.open("GET","../QuanLySieuThi/ajax.aspx?do=loaddanhsachchitietphieuxuat&kho="+oKho+"&times="+Math.random(),true);
        xmlHttp.send(null);
    }
    function suaitemchitietpx(objmactp)
    {
        ...
        var ock = document.getElementById("txtchietkhau_" + objmactp);
        var oKho = document.getElementById("ddlKho").value;
        xmlHttp = GetMSXmlHttp();
        xmlHttp.onreadystatechange = function()
        {
        ...
        xmlHttp.open("GET","../QuanLySieuThi/ajax.aspx?do=loadedititemphieuxuat&mactp="+objmactp+"&mavt="+omavt.value+"&soluong="+osoluong.value+"&dongia="+odongia.value+"&chietkhau="+ock.value+"&kho="+oKho+"&times="+Math.random(),true);
        xmlHttp.send(null);
    }
    ...
    function xoaitemchitietpx(objmactp)
    {
        ...
        xmlHttp.open("GET","../QuanLySieuThi/ajax.aspx?do=loaddeleteitemphieuxuat&mactp="+objmactp+"&kho="+oKho+"&times="+Math.random(),true);
        xmlHttp.send(null);
    }
...
////        }
    ...
    {
    //ThuanNH tam rem 20/05/2010 - bao loi khi ban san pham (Quan ly sieu thi)
//        if (omavt.value == "0")
//        {
//            alert("Bạn chưa nhập tên thuốc. Vui lòng kiểm tra lại.");
//            omavt.focus();
...
function savenewnhacungcap()
{
    try
    {
        ...
        if(document.getElementById("rad_ncc").checked==true)
        {
            var ddimei=document.getElementsByName("m_ddimei")[0];
            if(ddimei.value=="")
            {
...
{
    var f = document.kho;
    f.secondtime.value = "timnhacungcap";
    f.submit();
}
...
function fnKeepSessionLive() 
{
    ...
    window.setTimeout("fnKeepSessionAlive();", 3600);
} 
//fnKeepSessionLive(); 