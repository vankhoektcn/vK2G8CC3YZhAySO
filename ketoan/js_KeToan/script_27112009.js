...
function loadCheckManv(manv)
{
    ...
    xmlHttp.onreadystatechange = function()
    {
        if(xmlHttp.readyState == 4)
        {
            ...
            {
                var f = document.user;
                f.secondtime.value = "saveNewUser";
                f.submit();
            }
        }
    }
...
function createTable(divname,divchildname,title,ajaxname,sloganajax,error,url, wid, hei)
{
    try
    {
        ...
        td.style.backgroundColor="#7897DD";
        td.style.fontFamily = "tahoma";
        td.style.fontSize = "11px";
        td.style.fontWeight = "bold";
        td.style.color = "#E7E4DF";
...
/************* Ket thuc cac ham xu ly danh muc thuoc ******************/  
  ...
  function Anthongtin()
	...
	function SetDongia(objvattu,objdongia)
	{
	    ...
	    var sVt = objvt.options[objvt.selectedIndex].value; 
	    var objdg = document.getElementById(objdongia);
	    LoadDonGia(sVt);
	}
...
//                LoadInfoThuoc(sVT);
    ...
    function DoActionPhieuNhap(e)
    {
        ...
        if(keycode == 13)
        {
            ...
            {
                if (CheckThongTinPhieuNhap(oSoCt, oNgayCt, oKho, oDienGiai) && CheckThongTinCTPhieuNhap(omavt,osoluong,odongia, ongayhethan))
                {
                    LuuPhieuNhap(oSoCt.value, oNgayCt.value, oKho.value, oDienGiai.value, omavt.value, osoluong.value, odongia.value, ongayhethan.value);
                }
            }
            else
            {
               if( CheckThongTinCTPhieuNhap(omavt,osoluong,odongia, ongayhethan))
               {
                     LuuChiTietPhieuNhap(omavt.value, osoluong.value, odongia.value, ongayhethan.value);
...
//            CheckNew();            
    ...
    function CheckThongTinPhieuNhap(oSoCt, oNgayCt, oKho, oDienGiai)
    {
        if (oSoCt.value == "")
        {
    ...
    function CheckThongTinCTPhieuNhap(omavt,osoluong,odongia, ongayhethan)
    {
        if (omavt.value == "0")
        {
    ...
    function LuuPhieuNhap(oSoCt, oNgayCt, oKho, oDienGiai, omavt, osoluong, odongia, ongayhethan)
    {
        xmlHttp = GetMSXmlHttp();
        xmlHttp.onreadystatechange = function()
        {
        ...
        xmlHttp.open("GET","ajax.aspx?do=luuphieunhap&soct="+oSoCt+"&ngayct="+oNgayCt+"&kho="+oKho+"&diengiai="+myEscape(oDienGiai)+"&mavt="+omavt+"&soluong="+osoluong+"&dongia="+odongia+"&ngayhethan="+ongayhethan+"&times="+Math.random(),true);
        xmlHttp.send(null);
    }
    function LuuChiTietPhieuNhap(omavt,osoluong,odongia, ongayhethan)
    {
        xmlHttp = GetMSXmlHttp();
        xmlHttp.onreadystatechange = function()
        {
        ...
        xmlHttp.open("GET","ajax.aspx?do=luuctphieunhap&mavt="+omavt+"&soluong="+osoluong+"&dongia="+odongia+"&ngayhethan="+ongayhethan+"&times="+Math.random(),true);
        xmlHttp.send(null);
    }
    ...
    function suaitemchitiet(objmactp)
    {
        ...
        xmlHttp.open("GET","ajax.aspx?do=loadedititemphieunhap&mactp="+objmactp+"&mavt="+omavt.value+"&soluong="+osoluong.value+"&dongia="+odongia.value+"&ngayhethan="+ongayhethan.value+"&times="+Math.random(),true);
        xmlHttp.send(null);
    }
...
//==================Bat dau xu ly phan phieu xuat kho==================================
    ...
    function DoActionPhieuXuat(e)
    {
        ...
        if(keycode == 13)
        {
            ...
            {
                if (CheckThongTinPhieuXuat(oSoCt, oNgayCt, oDienGiai) && CheckThongTinCTPhieuXuat(omavt,osoluong,odongia))
                {
                    LuuPhieuXuat(oSoCt.value, oNgayCt.value, oDienGiai.value, omavt.value, osoluong.value, odongia.value);
                }
            }
            else
            {
               if( CheckThongTinCTPhieuXuat(omavt,osoluong,odongia))
               {
                     LuuChiTietPhieuXuat(omavt.value, osoluong.value, odongia.value);
    ...
    function CheckThongTinPhieuXuat(oSoCt, oNgayCt, oDienGiai)
    {
        if (oSoCt.value == "")
        {
            alert("Bạn chưa nhập số chứng từ. Vui lòng kiểm tra lại.");
    ...
    function CheckThongTinCTPhieuXuat(omavt,osoluong,odongia)
    {
        if (omavt.value == "0")
        {
            alert("Bạn chưa nhập tên thuốc. Vui lòng kiểm tra lại.");
    ...
    function LuuPhieuXuat(oSoCt, oNgayCt, oDienGiai, omavt, osoluong, odongia)
    {
        xmlHttp = GetMSXmlHttp();
        xmlHttp.onreadystatechange = function()
        {
        ...
        xmlHttp.open("GET","ajax.aspx?do=luuphieuxuat&soct="+oSoCt+"&ngayct="+oNgayCt+"&diengiai="+myEscape(oDienGiai)+"&mavt="+omavt+"&soluong="+osoluong+"&dongia="+odongia+"&times="+Math.random(),true);
        xmlHttp.send(null);
    }
    function LuuChiTietPhieuXuat(omavt,osoluong,odongia)
    {
        xmlHttp = GetMSXmlHttp();
        xmlHttp.onreadystatechange = function()
        {
        ...
        xmlHttp.open("GET","ajax.aspx?do=luuctphieuxuat&mavt="+omavt+"&soluong="+osoluong+"&dongia="+odongia+"&times="+Math.random(),true);
        xmlHttp.send(null);
    }
...
//================================== Bat dau xu ly toa thuoc
    function DoActionToaThuoc(e)
    {
        ...
        if(keycode == 13)
        {
            ...
            if (opxid.value == "-1") // da them moi thanh cong 1 phieu Xuat
            {
                ...
                {
                    LuuToaThuoc(oSoCt.value, oNgayCt.value, oDienGiai.value, oDiaChi.value, omavt.value, osoluong.value, odongia.value);
                }
            }
            else
            {
    ...
    function CheckThongTinToaThuoc(oSoCt, oNgayCt, oKho, oDienGiai, oDiaChi)
    {
        if (oSoCt.value == "")
        {
            alert("Bạn chưa nhập số chứng từ. Vui lòng kiểm tra lại.");
		...
		if (oDienGiai.value == "")
        {
            alert("Bạn chưa nhập họ tên khách hàng. Vui lòng kiểm tra lại.");
            oDienGiai.focus();
            return false;
        }
    ...
    function CheckThongTinCTToaThuoc(omavt,osoluong,odongia)
    {
        if (omavt.value == "0")
        {
            alert("Bạn chưa nhập tên thuốc. Vui lòng kiểm tra lại.");
    ...
    function LuuToaThuoc(oSoCt, oNgayCt, oDienGiai, oDiaChi, omavt, osoluong, odongia)
    {
        xmlHttp = GetMSXmlHttp();
        xmlHttp.onreadystatechange = function()
        {
            if(xmlHttp.readyState == 4)
            {
                ...
                if (value == "0")
                {
                    alert("Số tao thuốc này đã tồn tại. Vui lòng chọn số toa thuốc khác.")
                    return;
                }
                if (value == "1")
                {
        ...
        xmlHttp.open("GET","ajax.aspx?do=luutoathuoc&soct="+oSoCt+"&ngayct="+oNgayCt+"&hoten="+myEscape(oDienGiai)+"&diachi="+myEscape(oDiaChi)+"&mavt="+omavt+"&soluong="+osoluong+"&dongia="+odongia+"&times="+Math.random(),true);
        xmlHttp.send(null);
    }
    function LuuChiTietToaThuoc(omavt,osoluong,odongia)
    {
        xmlHttp = GetMSXmlHttp();
        xmlHttp.onreadystatechange = function()
        {
        ...
        xmlHttp.open("GET","ajax.aspx?do=luucttoathuoc&mavt="+omavt+"&soluong="+osoluong+"&dongia="+odongia+"&times="+Math.random(),true);
        xmlHttp.send(null);
    }
