...
public partial class KTVT_BaoCaoKhauHaoTSCD : System.Web.UI.Page
{    
    ...
    {               
        ...
        crystalReport.Load(Server.MapPath("../ketoan/report_KeToan/KTVT_BaoCaoKhauHaoTSCD.rpt"));//file:///E:\PHAN MEM QUAN LY\quanlythuoc\report\toathuocnguoidung.rpt        
    ...
    private DataTable LoadKhauHaoCCDC()
    {
        ...
        dtSRC = null;
        sql = "exec spBaoCaoKhauHaoTSCD'" +StaticData.CheckDate(txtNgay.Text) + "','" +StaticData.CheckDate(txtDenNgay.Text) + "'";                
