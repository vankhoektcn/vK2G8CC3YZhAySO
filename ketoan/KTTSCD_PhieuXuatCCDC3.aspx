<%@ Page Language="C#" MasterPageFile="~/ketoan/MasterPage_KT.master" AutoEventWireup="true" CodeFile="KTTSCD_PhieuXuatCCDC3.aspx.cs" Inherits="ketoan_KTTSCD_PhieuXuatCCDC3" %>

<%@ Register Src="Menu_KT/uscmenuKT_CCDC.ascx" TagName="uscmenuKT_TaiSan" TagPrefix="uc1" %>
 <asp:Content ID="Content1" ContentPlaceHolderID="header" Runat="Server">
     <script type="text/javascript" src="javascript/KTTSCD_PhieuXuatCCDC3.js">
     </script>
 </asp:Content>
 ...
 <uc1:uscmenuKT_TaiSan ID="UscmenuKT_TaiSan1" runat="server" />
     <div class="body-div">
             <div class="header-div">
                 <%=hsLibrary.clDictionaryDB.sGetValueLanguage("Phiếu Xuất Công Cụ Dụng Cụ")%>
           </div>
 <div class="in-a">
 <div class="div-Out">
     <div class="div-Left">
...
<%-- <div class="div-Out">
 ...
 <div class="div-Out">
     <div class="div-Left">
         <%=hsLibrary.clDictionaryDB.sGetValueLanguage("Tên Phòng")%>
     </div>
     <div class="div-Right">
        ...
        <input mkv="true" id="dien_giai" type="text" onfocus="Find(this);chuyenphim(this);" style="width:90%"/>
         ...
         <div align="right">
            <table>
             ...
             <div class="in-a">
                 <input  id="luu"  edit="<%=StaticData.HavePermision(this, "KeToanCCDC_KTTSCD_PhieuXuatCCDC3_Sua") %>" add="<%=StaticData.HavePermision(this, "KeToanCCDC_KTTSCD_PhieuXuatCCDC3_Them") %>" type="button" value="<%=hsLibrary.clDictionaryDB.sGetValueLanguage("save") %> "
                      />
