<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hethongdanhmuc.aspx.cs" Inherits="hethongdanhmuc" %>
    ...
    <tr>
        <td width = "100%" align = "left" >
            <table border="0" cellpadding="1" cellspacing="1" width="100%" id="user">
                <tr>
                    <td width = "100%" class = "header">PHẦN MỀM QUẢN LÝ: HỆ THỐNG DANH MỤC</td>
                </tr>
                <tr>
