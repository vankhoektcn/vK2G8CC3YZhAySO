<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HDDV_rptInPhieuThu.aspx.cs" Inherits="HDDV_rptInPhieuThu" %>
<!--#include file ="header.htm"-->
<%@ Register Src="~/ketoan/Menu_KT/uscmenuKT_HoadonDV.ascx" TagName="menu_ketoanhoadonDV" TagPrefix="uc2" %>
...
<table cellpadding = "0" cellspacing = "0" border = "0" width = "100%" >
    <tr>
        <td align = "left" valign = "top" style="height: 34px;background-color:#007138" >
            <uc2:menu_ketoanhoadonDV ID="menu_ketoanhoadonDV1" runat="server" />
        </td>
    </tr>
    <tr>
