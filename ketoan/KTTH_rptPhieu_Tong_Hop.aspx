<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KTTH_rptPhieu_Tong_Hop.aspx.cs" Inherits="ketoan_KTTH_rptPhieu_tong_hop" %>
			    ...
			    <table id="user" cellSpacing="1" cellPadding="1" width="100%" border="0" class = "khung">
				    <tr>
				        <td class="title" align = "center" style ="background-color: #4D67A2">
			                <span class="title" style ="color:#FFFFFF">IN PHIẾU KẾ TOÁN</span></td>
				    </tr>
				    <TR>
					    <TD width="100%">
					    </TD>
