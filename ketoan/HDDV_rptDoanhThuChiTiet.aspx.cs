...
public partial class HDDV_rptDoanhThuChiTiet : System.Web.UI.Page
{
    ...
    {        
        ...
        crystalReport.Load(Server.MapPath("../ketoan/report_KeToan/HDDV_rptDoanhThuChiTiet.rpt"));//file:///E:\PHAN MEM QUAN LY\quanlythuoc\report\toathuocnguoidung.rpt        
    ...
    {
//        string sql = @"select tenbenhnhan
//		,diachi,ten_doanh_thu
//		,thanh_tien_bn_tra=sum(thanh_tien_bn_tra)
//		,ngay_thu
//            from dbo.KB_GetDoanhThu_chitiet('" + StaticData.CheckDate_kt(txtNgay.Text) + "','" + StaticData.CheckDate_kt(txtDenNgay.Text) + "') a";
//        sql += " group by tenbenhnhan,diachi,ten_doanh_thu,ngay_thu order by ten_doanh_thu,ngay_thu";
        string sql = "";
        sql = @"select a.tenbenhnhan,b.diachi,noidungthu,sum(tongtien)thanhtien,convert(varchar(10),sysdate,103)ngaythu from hs_dsdathu a left join benhnhan b on a.mabenhnhan=b.mabenhnhan
            ...
            group by a.tenbenhnhan,b.diachi,noidungthu,convert(varchar(10),sysdate,103) order by tenbenhnhan,noidungthu";
