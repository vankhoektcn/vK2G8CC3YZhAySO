<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DanhSachBNDKKham.aspx.cs" Inherits="DanhSachBNDKKham" %>
                            ...
                            <table id="user" cellspacing="1" cellpadding="1" width="100%" border="0" class="khung">
                                <tr>
                                    <td class="title" align="center" style="background-color: #4D67A2; height: 21px;">
                                        <span class="title" style="color: #FFFFFF">DANH SÁCH BỆNH NHÂN NHẬP KHOA</span></td>
                                </tr>
                                <tr>
                                    <td width="100%">
...
Khoa : <asp:DropDownList id="Khoa" runat="server" style="width:200px;" >
                                                                ...
                                                                <fieldset style="width:100%;padding-bottom:10px;">
                                                                    ...
                                                                    <div style="padding:10px;">
                                                                        Từ ngày :
                                                                        <asp:textbox id="Tungay" runat="server" ></asp:textbox>
                                                                        Đến ngày:
                                                                        <asp:textbox id="Denngay" runat="server" ></asp:textbox>
