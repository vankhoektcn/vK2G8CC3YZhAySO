<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KTCN_NhaCungCap_TH_vantam.aspx.cs" Inherits="KTCN_NhaCungCap_TH" %>
			    ...
			    <table id="user" cellSpacing="1" cellPadding="1" width="100%" border="0" class = "khung">
				    <tr>
				        <td class="title" align = "center" style ="background-color: #4D67A2">
			                <span class="title" style ="color:#FFFFFF">CÔNG NỢ TỔNG HỢP NHÀ CUNG CẤP</span></td>
				    </tr>
				    <TR>
					    <TD width="100%">
                            Từ ngày:
                            ...
                            &nbsp;Tài khoản:
                            <asp:dropdownlist id="drltkcn1" runat="server" autopostback="true"> </asp:dropdownlist> 
