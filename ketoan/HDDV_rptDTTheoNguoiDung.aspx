<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HDDV_rptDTTheoNguoiDung.aspx.cs" Inherits="HDDV_rptDTTheoNguoiDung" %>
...
<table cellpadding = "0" cellspacing = "0" border = "0" width = "100%" >
    <tr>
        <td align = "left" valign = "top" style="height: 34px" bgcolor = "#EAEBE6">
            <uc2:menu_ketoanhoadonDV ID="menu_ketoanhoadonDV" runat="server" />
        </td>
    </tr>
    <tr>
			    ...
			    <table id="user" cellSpacing="1" cellPadding="1" width="100%" border="0" class = "khung">
				    <tr>
				        <td class="title" align = "center" style ="background-color: #4D67A2">
			                <span class="title" style ="color:#FFFFFF">BÁO CÁO DOANH THU THEO NGƯỜI DÙNG</span></td>
				    </tr>
				    <TR>
					    <TD width="100%">
                            Từ ngày:
                            ...
                            đến ngày:
                            <asp:textbox id="txtDenNgay" runat="server" height="20px" tabindex="2" width="149px"></asp:textbox> <asp:button id="btnRefesh" runat="server"  text="...." OnClick="btnRefesh_Click" />
                            &nbsp;&nbsp;
                            <asp:dropdownlist id="drlnguoidung" runat="server"></asp:dropdownlist>                           
