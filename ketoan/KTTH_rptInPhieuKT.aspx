<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KTTH_rptInPhieuKT.aspx.cs" Inherits="KTTH_rptInPhieuKT" %>
<!--#include file ="header.htm"-->
<%@ Register Src="~/ketoan/Menu_KT/uscmenuKT_TongHop.ascx" TagName="uscmenuKT_TongHopPTKT" TagPrefix="uc1" %>
...
<table cellpadding = "0" cellspacing = "0" border = "0" width = "100%" >
    <tr>
        <td align = "left" valign = "top" style="height: 34px;background-color:#007138" >
            <uc1:uscmenuKT_TongHopPTKT ID="uscmenuKT_TongHopPTKT1" runat="server" />
        </td>
    </tr>
    <tr>
			    ...
			    <table id="user" cellSpacing="1" cellPadding="1" width="100%" border="0" class = "khung">
				    <tr>
				        <td class="title" align = "center" style ="background-color: #4D67A2">
			                <span class="title" style ="color:#FFFFFF">IN PHIẾU THU CHI</span></td>
				    </tr>
				    <TR>
					    <TD width="100%">
					    </TD>
