...
public partial class KTTH_ChungTuGhiSo : System.Web.UI.Page
{
    ...
    {
        string sql="" ;                               
        if (txtTaiKhoan.Text != "" && txtTaiKhoanCo.Text=="")
        {
            ...
            if (txtTaiKhoanCo.Text != "" && txtTaiKhoan.Text=="")
            {
                ...
                {
                    sql = "select ma_ct,ngay_lap_ct,tai_khoan,tai_khoan_du,ps_no,ps_co,dien_giai from so_cai ";
                    sql += " where (ngay_lap_ct between '" + StaticData.CheckDate_kt(txtNgay.Text) + "' and '" + StaticData.CheckDate_kt(txtDenNgay.Text) + "') and tai_khoan like '" + txtTaiKhoan.Text + "%' and tai_khoan_du like '" + txtTaiKhoanCo.Text + "%'"; ;
                    sql += " and ps_no<>0";
                    sql += " order by ngay_lap_ct, ma_ct";
                }
                else
