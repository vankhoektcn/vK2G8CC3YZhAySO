...
public partial class KTCN_Khach_Hang_TH : System.Web.UI.Page
{
    ...
    void loadtk()
    {
        ...
        StaticData.FillCombo(drltkcn, dt, "taikhoan", "taikhoan");
    }
    void load()
    {
    ...
    private DataTable LoadCongNoKhachHang_TH(string strTK)
    {
        ...
        dtSRC = null;
        sql = "exec spCong_No_Khach_Hang_TH  '" + ngay_dau_nam+"','"+ StaticData.CheckDate_kt(txtNgay.Text) + "','" + StaticData.CheckDate_kt(txtDenNgay.Text) + "','" + strTK + "'";
