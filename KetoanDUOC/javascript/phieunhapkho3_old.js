$(document).ready(function() {
    ...
    {        
                $.ajax({
                    async:false,
                    cache:false,
                    url:"../ajax/phieunhapkho_ajax3.aspx?do=LuuSoCai&idphieunhap=" + $.mkv.queryString("idkhoachinh")+"&maphieunhap="+$("#maphieunhap").val()+"&ngaythang="+$("#ngaythang").val()+"&nhacungcapid="+$("#nhacungcapid").val()+"&sohoadon="+$("#sohoadon").val()+"&ngayhoadon="+$("#ngayhoadon").val()+"&tkco="+$("#tkco").val()+"&tkvat="+$("#tkvat").val()+"&tkck="+$("#tkno").val()+"&thuesuat="+$("#vat").val()+"&ghichu="+$("#ghichu").val(),
                    success:function(data){                        
                    }
                }); 
    }
...
function tinhtongtien()
{
    ...
    {
    try{
    if(typeof eval(document.getElementById(tablegrid).rows[i].cells[11].getElementsByTagName("input")[0].value.replace(/\$|\,/g,''))!='undefined')
        tientruocthue += eval(document.getElementById(tablegrid).rows[i].cells[11].getElementsByTagName("input")[0].value.replace(/\$|\,/g,''));
    if(typeof eval(document.getElementById(tablegrid).rows[i].cells[13].getElementsByTagName("input")[0].value.replace(/\$|\,/g,''))!='undefined')
        tiensauthue += eval(document.getElementById(tablegrid).rows[i].cells[13].getElementsByTagName("input")[0].value.replace(/\$|\,/g,''));s  
    }catch(ex){}
    }
