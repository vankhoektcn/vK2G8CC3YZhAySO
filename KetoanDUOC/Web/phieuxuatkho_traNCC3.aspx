 <%@ Page Language="C#" MasterPageFile="../MasterPage.master" AutoEventWireup="true" CodeFile="phieuxuatkho_traNCC3.aspx.cs" Inherits="phieuxuatkho_traNCC3" Title="phieuxuatkho_traNCC3" %>
 ...
 <div class="div-Out">
     ...
     <p>
        ...
        <input mkv="true" id="mkv_idnhacungcap" type="text" onfocus="Find(this);chuyenphim(this);idnhacungcapSearch(this);" class="down_select" style="width:90%"/>
     </p>
 </div>
  <div class="div-Out">
                <h4>
