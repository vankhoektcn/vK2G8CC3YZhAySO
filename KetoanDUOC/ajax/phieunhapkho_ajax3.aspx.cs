...
public partial class phieunhapkho_ajax : System.Web.UI.Page
{
    protected DataProcess s_phieunhapkho()
    {
        ...
        phieunhapkho.data("tkno", Request.QueryString["tkck"]);
    ...
    private void Savephieunhapkho()
    {
        try
        {
            ...
            {
                string tkno = process.getData("tkno");
                string tkco = process.getData("tkco");
                string tkvat = process.getData("tkvat");
                string sqlupdate = "update phieunhapkho set tkno='" + tkno + "',tkco='" + tkco + "',tkvat='" + tkvat + "' where idphieunhap=" + process.getData("idphieunhap");
    ...
    public void loadTablechitietphieunhapkho()
    {
        ...
        html.Append("<th style='width:40px'>" + hsLibrary.clDictionaryDB.sGetValueLanguage("SL\r\nlẻ") + "</th>");
        html.Append("<th style='width:40px'>" + hsLibrary.clDictionaryDB.sGetValueLanguage("Đơn giá\r\nlẻ") + "</th>");
        html.Append("<th  style='width:50px'>" + hsLibrary.clDictionaryDB.sGetValueLanguage("TkNo") + "</th>");
        ...
        if (search)
        {
            ...
            DataTable table = DataAcess.Connect.GetTable(@"select STT=row_number() over (order by T.idchitietphieunhapkho),T.*
                   ,D.MaLoai
                   ,B.tenthuoc
                   ...
                   ,B.SLQuyDoi
                   ,B.tkkho         
                   ,thanhtien2=(t.thanhtientruocthue+t.tienthue)          
            ...
            if (table.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < table.Rows.Count; i++)
                {
                    ...
                    html.Append("<td><input mkv='true' id='idthuoc' type='hidden' value='" + table.Rows[i]["idthuoc"] + "'/><input mkv='true' id='mkv_idthuoc' type='text' value='" + table.Rows[i]["tenthuoc"].ToString() + "' onfocus='idthuocSearch(this);'  onblur='CheckExistThuoc(this);'  class=\"down_select\" " + (!edit ? "disabled" : "") + "/></td>");
                    ...
                    html.Append("<td><input mkv='true' id='Dongia_N' type='text' onfocusout='chuyenformout(this)' onfocus='chuyendong(this);chuyenphim(this);' value='" + string.Format(new System.Globalization.CultureInfo("de-DE"), "{0:0,0.###}", table.Rows[i]["Dongia_N"]) + "' onblur='QuyDoiDVTChan(this);tinhtongtien();' " + (!edit ? "disabled" : "") + " style='width:70px; text-align:right;'/></td>");
                    ...
                    html.Append("<td><input mkv='true' id='Soluong' type='text' onfocusout='chuyenformout(this)' onfocus='chuyendong(this);chuyenphim(this);' value='" + table.Rows[i]["Soluong"].ToString() + "' onblur='QuyDoiDVTLe(this);tinhtongtien();' " + (!edit ? "disabled" : "") + " style='width:40px; text-align:right;'/></td>");
                    html.Append("<td><input mkv='true' id='Dongia' type='text' onfocusout='chuyenformout(this)' onfocus='chuyendong(this);chuyenphim(this);' value='" + string.Format(new System.Globalization.CultureInfo("de-DE"), "{0:0,0.###}", table.Rows[i]["Dongia"]) + "' onblur='QuyDoiDVTLe(this);tinhtongtien();' " + (!edit ? "disabled" : "") + " style='width:70px; text-align:right;'/></td>");
                    html.Append("<td><input mkv='true' id='tkno' type='hidden' style='width:50px; text-align:center;' value='" + (string.IsNullOrEmpty(table.Rows[i]["tkno"].ToString()) ? table.Rows[i]["tkkho"] : table.Rows[i]["tkno"]) + "'/><input mkv='true' id='mkv_tkno' type='text' style='width:70px; text-align:center;'  value='" + (string.IsNullOrEmpty(table.Rows[i]["tkno"].ToString()) ? table.Rows[i]["tkkho"] : table.Rows[i]["tkno"]) + "' onfocus='tknoSearch(this);' class=\"down_select\" " + (!edit ? "disabled" : "") + "/></td>");
                    html.Append("<td><input mkv='true' id='thanhtientruocthue' type='text' onfocusout='chuyenformout(this)' onfocus='chuyendong(this);chuyenphim(this);' value='" + string.Format(new System.Globalization.CultureInfo("de-DE"), "{0:0,0.###}", table.Rows[i]["thanhtientruocthue"]) + "' onblur='tinhthanhtien(this);' " + (!edit ? "disabled" : "") + " style='width:100%;text-align:right;'/></td>");
                    ...
                    html.Append("<td><input mkv='true' id='ThanhTien' type='text' onfocusout='chuyenformout(this)' onfocus='chuyendong(this);chuyenphim(this);' value='" + string.Format(new System.Globalization.CultureInfo("de-DE"), "{0:0,0.###}", table.Rows[i]["thanhtien2"]) + "' " + (!edit ? "disabled" : "") + " style='width:100%;text-align:right;'/></td>");
        ...
        if (add)
        {
            ...
            html.Append("<td><input mkv='true' id='idthuoc' type='hidden' value=''/><input mkv='true' id='mkv_idthuoc' type='text' value='' onfocus='idthuocSearch(this);'  onblur='CheckExistThuoc(this);' class=\"down_select\"/></td>");
            ...
            html.Append("<td><input mkv='true' id='tkno' type='hidden' value=''/><input mkv='true' id='mkv_tkno' type='text' style='width:50px; text-align:center;' value='' onfocus='tknoSearch(this);' class=\"down_select\"/></td>");
    ...
    public void LuuSoCai()
    {
        ...
        string ma_ncc = dtmancc.Rows[0][0].ToString();
