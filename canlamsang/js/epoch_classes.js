...
function Epoch(name,mode,targetelement,multiselect) {
	...
	*/
	function setLang() {
		self.daylist = new Array('H','B','T','N','S','B','CN','H','B','T','N','S','B','CN');
...
Date.prototype.dateFormat = function(format)
{
	...
	var DAY_NAMES = new Array('Thứ hai','Thứ Ba','Thứ tư','Thứ năm','Thứ sáu','Thứ bảy','Thứ chín','Hai','Ba','Tư',' Năm','Sáu','Bảy','CN');
	var result="";
	var i_format=0;
	var c="";
	var token="";
