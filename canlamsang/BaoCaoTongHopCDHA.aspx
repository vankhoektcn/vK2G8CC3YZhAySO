<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="BaoCaoTongHopCDHA.aspx.cs" Inherits="BaoCaoTongHopCDHA" %>
				    ...
				    <tr>
				        <td class="title" colspan = "2" align = "center" style="background-color: #4D67A2; height: 19px;">
					        <p class="title" style ="color:#FFFFFF">
                                BÁO CÁO TỔNG HỢP KHOA CHẨN ĐOÁN HÌNH ẢNH </p>
				        </td>
			        </tr>
				    <TR>
					    <TD width="100%">
