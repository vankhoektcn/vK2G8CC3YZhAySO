<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="BaoCaoTongHopXetNghiem.aspx.cs" Inherits="BaoCaoTongHopXetNghiem" %>
...
<script type="text/javascript" src="../epoch_Ha.js"></script>
				    ...
				    <tr>
				        <td class="title" colspan = "2" align = "center" style="background-color: #4D67A2; height: 19px;">
					        <p class="title" style ="color:#FFFFFF">
                                BÁO CÁO TỔNG HỢP SỐ TEST CHẠY ĐƯỢC</p>
				        </td>
			        </tr>
				    <TR>
					    <TD width="100%">
													   ...
													   <tr style="text-align:left">	
				                                        ...
				                                        <tr style="text-align:left">
				                                            <td align="center" style="height: 22px" colspan="2">
				                                                <asp:button id="btnTim" runat="server" text="Lấy Danh sách" onClientClick="return checkvalid();" OnClick="btnTim_Click" Width="164px" /></td>				                                           
				                                        </tr>
												    </TABLE>
                                                  </TD>
										    </TR>
