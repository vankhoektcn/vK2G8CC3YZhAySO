<%@ Page Language="C#" CodeFile="dieutrikhachlecanlamsan.aspx.cs" Inherits="dieutrikhachlecanlamsan" %>
		        ...
		        <td width="100%" valign="top" style="PADDING-LEFT:0px; PADDING-TOP:0px">
				    ...
				    <tr>
					    <td class="title" style =" padding-top:10px; padding-bottom:0px">
						    <p class="title"><input type = "hidden" id = "iddieutri" value = "0" runat = "server" /></p>
					    </td>
				    </tr>
				    <TR>
					    <TD width="100%">
											    ...
											    <TD align="left" width="100%" style="height: 100px">
												    <TABLE style="HEIGHT: 17px" cellSpacing="0" cellPadding="0" width="100%" border="0">
													    ...
													    <TR style ="padding-bottom:10px">
														    ...
														    <TD vAlign="top" align="left" width="85%" style="WIDTH: 85%; height:auto">
