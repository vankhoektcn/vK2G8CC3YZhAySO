<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PhieuHenKQ.aspx.cs" Inherits="canlamsang_PhieuHenKQ" %>
...
<body>
    <form id="form1" runat="server">
     <table cellpadding = "0" cellspacing = "0" border = "0" width = "100%">
		        <tr>
		            <td width = "100%" align = "left"  style ="height:25px; background-color: #E7E4DF"><span class = "Tieude"><%= StaticData.TenCty %> Người dùng: <%=  SysParameter.UserLogin.FullName(this).ToString() %> <span onclick = "Thoat()" style="cursor:pointer">[Thoát]</span></td>
		        </tr>		        
		    </table>
