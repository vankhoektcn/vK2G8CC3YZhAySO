<%@ Control Language="C#" AutoEventWireup="true" CodeFile="KhamCapCuu.ascx.cs"
    Inherits="usercontrols_capcuu_KhamCapCuu" %>
<script type="text/javascript" src="../js/script.js">
</script>
<script type="text/javascript" src="../javascript/khamcapcuu.js">
</script>
