<%@ Control Language="C#" AutoEventWireup="true" CodeFile="kcb_quanly_sosinh.ascx.cs" Inherits="kcb_chandoan_khoangoai" %>
...
<style type="text/css">
 ...
 <div class="body-div" style="margin-top:-98px;border-top:none;">
             <div class="header-div">
                II. <%=hsLibrary.clDictionaryDB.sGetValueLanguage("kcb_quanly_sosinh")%>
           </div>
 <div class="in-a">
