<%@ Control Language="C#" AutoEventWireup="true" CodeFile="kcb_chandoanvaokhoa_phukhoa.ascx.cs" Inherits="kcb_chandoan_phukhoa" %>
     ...
     <div class="body-div" style="margin-top:-98px;border-top:none">
             <div class="header-div">
                A.IV,V,VI.<%=hsLibrary.clDictionaryDB.sGetValueLanguage("kcb_chandoanvaokhoa_phukhoa")%>
           </div>
 <div class="in-a">
 <div class="div-Out">
