<%@ Control Language="C#" AutoEventWireup="true" CodeFile="kcb_chandoan_sosinh.ascx.cs" Inherits="kcb_chandoan_khoangoai" %>
...
<div class="body-div"  style="margin-top:-98px;border-top:none">
             <div class="header-div">
                 III.<%=hsLibrary.clDictionaryDB.sGetValueLanguage("kcb_chandoan_sosinh")%>
           </div>
 <div class="in-a">
 ...
 <div class="div-Out" style="padding-left:0;padding-right:20px;width:460px;padding-bottom:0">
     ...
     <%=hsLibrary.clDictionaryDB.sGetValueLanguage("cd_thuthuat")%>
        <input mkv="true" id="cd_thuthuat" type="checkbox" onfocus="chuyenphim(this);" />
        <%=hsLibrary.clDictionaryDB.sGetValueLanguage("cd_phauthuat")%>
        <input mkv="true" id="cd_phauthuat" type="checkbox" onfocus="chuyenphim(this);" />
     </div>
 </div>
 </div>
 <div style="border-bottom:1px solid #cfcfcf;border-right:1px solid #cfcfcf;position:relative;display:table;float:left;width:480px;height:290px">
  <div style="clear:both;background-color:#f2f6f8;border-bottom:1px solid #efefef;padding:10px 0 10px 0;height:10px;color:green;">
