<%@ Control Language="C#" AutoEventWireup="true" CodeFile="kcb_khambenh_khoangoai.ascx.cs" Inherits="kcb_chandoan_khoangoai" %>
 ...
 <div class="div-Out">
     <div class="div-Left" style="font-weight:bold;font-size:17px">
         <%=hsLibrary.clDictionaryDB.sGetValueLanguage("kb_benhngoaikhoa")%>
     </div>
     <div class="div-Right">
        <textarea mkv="true" id="kb_benhngoaikhoa" type="text" onfocus="Find(this);chuyenphim(this);" style="width:90%"></textarea>
     </div>
 </div>
