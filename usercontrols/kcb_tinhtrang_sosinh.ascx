<%@ Control Language="C#" AutoEventWireup="true" CodeFile="kcb_tinhtrang_sosinh.ascx.cs" Inherits="kcb_chandoan_khoangoai" %>
<script type="text/javascript" src="../javascript/kcb_sosinh.js">
     </script>
<div class="body-div"  style="margin-top:-98px;border-top:none">
             <div class="header-div">
                 IV.<%=hsLibrary.clDictionaryDB.sGetValueLanguage("kcb_tinhtrang_sosinh")%>
           </div>
 <div class="in-a">
