<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nvk_baoCaoTraThuoc.aspx.cs"
    Inherits="nvk_baoCaoTraThuoc" %>
...
<form id="Form1" method="post" runat="server">
    ...
    <div id="divFather" style="width: 99%;border: solid 1px Blue">
        <div id="divHeader" class="divHeader_" runat="server">
            BÁO CÁO TRẢ THUỐC, VTYT...</div>
            ...
            <div id="divTK1" class="divControl">
                <fieldset class="fieldset_CT">
                    ...
                    <input id="txtTuNgay" type="text" runat="server" onfocus="$(this).datepick();" onblur="nvk_testDate_this(this);"
                        style="width: 70px;" />
                        <input id="txtTuGio" type="text" runat="server" style="width: 40px;" visible="false"/>
                    <span class="spanText">Đến ngày :</span><input id="txtDenNgay" type="text" runat="server"
                        onfocus="$(this).datepick();" onblur="nvk_testDate_this(this);" style="width: 70px;" />
                        <input id="txtDenGio" type="text" runat="server" style="width: 40px;" visible="false" />
                        &nbsp;
                   ...
                   <%--<div style="clear:both;padding:10px 0px 2px 0px">--%>
