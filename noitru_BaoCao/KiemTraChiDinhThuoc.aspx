<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KiemTraChiDinhThuoc.aspx.cs"
    Inherits="noitru_BaoCao_KiemTraChiDinhThuoc" %>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $("#layds").click(function(){
                $(this).TimKiem({
                    ajax:"../ajax/DuTruThuoc_ajax2.aspx?do=LayDSDuTruThuoc" + "&idphongkhambenh=" + $.mkv.queryString("idphongkhambenh")+"&edithaophi="+queryString("editHaoPhi")+""
                    ,showPopup:false
                    ,readMKV:true
                },function(){
...
function LuuHaoPhiChiDinh()
{
 //$("BODY").append('<p id="loadingAjax" style="position:fixed;width:100%;top:0;left:0;right:0;bottom:0;z-index:2000;height:100%;opacity:0.2;filter:alpha(opacity=20);"><img src="../images/loading.gif" style="top:45%;left:45%;position:absolute"/></p>');
    $.LuuTable({
         ajax:"../ajax/DuTruThuoc_ajax2.aspx?do=luuTableHaoPhiChiDinh",
         tablename:"gridTableDSChiDinh"
        },null,function () 
            {
               //$("#loadingAjax").remove();                
			   //$.mkv.myalert("Đã hoàn thành !.",2000,"success");
			   alert("Đã hoàn thành !");
            }
         );//end LuuTable
}
            ...
            <div class="body-div">
                ...
                <div class="in-a">
                    <div class="div-Out">
                        ...
                        <p>
                            <input id="mabenhnhan" type="text" mkv="true" />
                        </p>
                    </div>
                    <div class="div-Out">
                        <h4>
                        ...
                        <p>
                            <input id="tenbenhnhan" type="text" mkv="true" />
                        </p>
                    </div>
                    <div class="div-Out">
                        <h4>
                        ...
                        <p>
                            <input id="tungay" type="text" onfocus="$(this).datepick();" mkv="true" />
                        </p>
                    </div>
                    <div class="div-Out" style="border-right: 1px solid #ccc">
                        ...
                        <p>
                            <input id="denngay" type="text" onfocus="$(this).datepick();" mkv="true" />
                        </p>
                    </div>
                    <div class="div-Out">
                        <h4>
                    ...
                    <div class="div-Out" id='divYeuCau'>
                        <h4>
                            Đã yêu cầu
                        </h4>
                        <p>
                            <input id="dutru" type="checkbox" mkv="true" />
                        </p>
                    </div>
                    ...
                    <div style="border:1px solid #ccc;width:100%;text-align:center">
