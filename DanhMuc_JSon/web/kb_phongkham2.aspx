 <%@ Page Language="C#" MasterPageFile="~/DanhMuc_JSon/MasterPage.master" AutoEventWireup="true" CodeFile="kb_phongkham2.aspx.cs" Inherits="kb_phongkham" Title="kb_phongkham" %>
 <asp:Content ID="Content1" ContentPlaceHolderID="header" Runat="Server">
     <script type="text/javascript" src="../javascript/kb_phongkham2.js">
     </script>
 </asp:Content>
 <asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
     <div class="body-div">
             <p class="header-div">
                 <%=hsLibrary.clDictionaryDB.sGetValueLanguage("kb_phongkham")%>
           </p>
 <div class="in-a">
 <div class="div-Out">
     <h4>
         <%=hsLibrary.clDictionaryDB.sGetValueLanguage("PhongID")%>
     </h4>
     <p>
        <input mkv="true" id="PhongID" type="hidden" />
        <input mkv="true" id="mkv_PhongID" type="text" onfocus="Find(this);PhongIDSearch(this);" class="down_select" style="width:90%"/>
     </p>
 </div>
 <div class="div-Out">
     <h4>
 ...
 <p class="in-a">
             ...
             <input  id="timKiem" search="<%=StaticData.HavePermision(this, "kb_phongkham_Search") %>" type="button" value="<%=hsLibrary.clDictionaryDB.sGetValueLanguage("find") %>"
                       />
             </p>
 <a class="reload" onclick="Find(this)"></a>
         <div class="in-b" id="tableAjax_kb_phongkham">
         </div>
 <p class="in-c">
