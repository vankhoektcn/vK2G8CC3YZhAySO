<%@ Page Language="C#" MasterPageFile="~/DanhMuc_JSon/MasterPage.master" AutoEventWireup="true"
    CodeFile="zBaoCaoBNRaVienChuyenVien1.aspx.cs" Inherits="zBaoCaoBNRaVienChuyenVien1"
    Title="Báo cáo ra viện chuyển viện" %>

<asp:Content ID="Content1" ContentPlaceHolderID="header" runat="Server">

    <script type="text/javascript" src="../javascript/zBaoCaoBNRaVienChuyenVien1.js">
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="body-div">
        <p class="header-div">
            <%=hsLibrary.clDictionaryDB.sGetValueLanguage("Báo cáo ra viện - chuyển viện")%>
        </p>
        <div class="in-a">
