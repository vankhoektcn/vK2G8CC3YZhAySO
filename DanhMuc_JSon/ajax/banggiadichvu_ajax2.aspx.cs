 ...
 public partial class banggiadichvu_ajax : System.Web.UI.Page
 {
     protected DataProcess s_banggiadichvu()
     {
             ...
             banggiadichvu.data("IsKTC",Request.QueryString["IsKTC"]);
             banggiadichvu.data("madichvu",Request.QueryString["madichvu"]);
             banggiadichvu.data("IsBatBuocthu",Request.QueryString["IsBatBuocthu"]);
             banggiadichvu.data("BHTra",Request.QueryString["BHTra"]);
             banggiadichvu.data("IDLoaiCLS",Request.QueryString["IDLoaiCLS"]);
             ...
             banggiadichvu.data("IsCLS",Request.QueryString["IsCLS"]);
             banggiadichvu.data("TenBaoHiem",Request.QueryString["TenBaoHiem"]);
             banggiadichvu.data("IsVC",Request.QueryString["IsVC"]);
             banggiadichvu.data("TENNHOMCD",Request.QueryString["TENNHOMCD"]);
             banggiadichvu.data("NHOMINBV01",Request.QueryString["NHOMINBV01"]);
             banggiadichvu.data("TT_NHOMINBV01",Request.QueryString["TT_NHOMINBV01"]);
             banggiadichvu.data("IsDVKT",Request.QueryString["IsDVKT"]);
             banggiadichvu.data("TTUUCAPCUU_NHOM",Request.QueryString["TTUUCAPCUU_NHOM"]);
             banggiadichvu.data("GIABH",Request.QueryString["GIABH"]);
             banggiadichvu.data("TTUTCAPCUU_DV",Request.QueryString["TTUTCAPCUU_DV"]);
