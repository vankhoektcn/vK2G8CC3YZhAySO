...
function Epoch(name,mode,targetelement,multiselect) {
	...
	*/
	function setLang() {
		self.daylist = new Array('CN','H','B','T','N','S','B','CN','H','B','T','N','S','B');
		self.months_sh = new Array('T.1','T.2','T.3','T.4','T.5','T.6','T.7','T.8','T.9','T.10','T.11','T.12');
		self.monthup_title = 'Tháng kế tiếp';
		self.monthdn_title = 'Tháng trước';
		self.clearbtn_caption = 'Xoá';
		self.clearbtn_title = 'Xoá những ngày đã chọn trên lịch';
		self.maxrange_caption = 'Đây là giới hạn tối đa !';
...
Date.prototype.dateFormat = function(format)
{
	...
	var MONTH_NAMES = new Array('Tháng một','Tháng hai','Tháng ba','Tháng bốn','Tháng năm','Tháng sáu','Tháng bảy','Tháng tám','Tháng chín','Tháng mười','Tháng mười một','Tháng mười hai','T.1','T.2','T.3','T.4','T.5','T.6','T.7','T.8','T.9','T.10','T.11','T.12');
	var DAY_NAMES = new Array('CN','Thứ hai','Thứ Ba','Thứ tư','Thứ năm','Thứ sáu','Thứ bảy','Thứ chín','Hai','Ba','Tư',' Năm','Sáu','Bảy');
	var result="";
	var i_format=0;
	var c="";
	var token="";
