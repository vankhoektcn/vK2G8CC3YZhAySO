...
<form id="Form1" method="post" runat="server">
    <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #C0C0C0">
        ...
        <tr>
            <td width="100%" align="left" style="background-color: #D4D0C8;">
                <table border="0" cellpadding="1" cellspacing="1" width="100%" id="user" style="border:1px solid #ddd">
                    <tr>
                        <td width="100%" class="header" style="background-color: #4D67A2">
                            <span class="title" style="color: #D4D0C8">PHÂN HỆ TIẾP NHẬN BỆNH NHÂN</span></td>
                    </tr>
                    <tr>
