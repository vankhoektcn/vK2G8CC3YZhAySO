<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="frp_ThongKeCaKCB.aspx.cs" Inherits="frp_ThongKeCaKCB" %>
				    ...
				    <tr>
				        <td class="title" colspan = "2" align = "center" style="background-color: #4D67A2; height: 19px;">
					        <p class="title" style ="color:#FFFFFF">
                                TỔNG HỢP SỐ CA KHÁM BỆNH THEO BÁC SĨ</p>
				        </td>
			        </tr>
				    <TR>
					    <TD width="100%">
