<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LoaiNgayNghiCtyEntry.aspx.cs" Inherits="LoaiNgayNghiCtyEntry" %>
                                        ...
                                        <table id="user" cellspacing="1" cellpadding="1" width="100%" border="0" class="khung">
                                            <tr>
                                                <td align="center" style="width: 100%; background-color: #FBF8F1; height: 19px; background-image: url(../images/menu.jpg);
                                                    ...
                                                    QUẢN LÝ DANH MỤC NGÀY NGHỈ CÔNG TY
                                                </td>
                                            </tr>
                                            <tr>
                                                                    ...
                                                                    <tr style="padding-bottom: 5px; padding-top: 10px">
                                                                        <td align="center" width="100%" style="height: 81px; padding-left: 50px">
                                                                            <table width="400px" rules="none" style="border-color: Blue; border-style: double;
                                                                                ...
                                                                                <tr>
                                                                                    <td valign="top"  align="left" style="height: 40px; padding-left: 10px; width:140px;">
                                                                                        <p class="ptext">
                                                                                            Loại ngày nghỉ:&nbsp;
                                                                                        </p>
                                                                                    </td>
                                                                                    <td valign="top" align="right"  style="width: 258px; height: 40px;padding-right:10px" colspan="3">
                                                                                        <p class="ptext">
                                                                                            <%--<asp:textbox id="txtMaLoaiNgayNghi" runat="server" width="248px" tabindex="4"></asp:textbox>--%>
                                                                                            <asp:dropdownlist cssclass="input" id="ddlLoaiNgayNghi" runat="server" width="248px" TabIndex="4" ></asp:dropdownlist>
                                                                                        </p>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td valign="top" align="right"  style="width: 258px; height: 40px;padding-right:10px" colspan="3">
                                                                                        <p class="ptext">
                                                                                            <asp:textbox id="txtMoTa"  cssclass="input" runat="server" width="248px" tabindex="4" TextMode="MultiLine"></asp:textbox>
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                        ...
                                                        <tr>
                                                            <td valign="top" align="right" width="100%" colspan="2" height="20">
                                                                <asp:datagrid id="dgr" tabindex="12" runat="server" width="100%" allowsorting="True"
                                                                    autogeneratecolumns="False" datakeyfield="idngaynghicongty" borderwidth="1px" bordercolor="Silver"
                                                                    onitemdatabound="dgr_ItemDataBound" cellpadding="2" ondeletecommand="DelLoaiNgayNghi"
...
<asp:BoundColumn DataField="loaingaynghi" HeaderText="Loại ngày nghỉ">
...
<HeaderStyle HorizontalAlign="Center" BackColor="#FFE0C0" Font-Bold="True" ForeColor="Blue"></HeaderStyle>
</asp:datagrid>
                                                                &nbsp;
                                                            </td>
                                                        </tr>
