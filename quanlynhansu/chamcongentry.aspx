<%@ Page Language="C#" AutoEventWireup="true" CodeFile="chamcongentry.aspx.cs" Inherits="chamcongentry" %>
...
<table style="BACKGROUND-COLOR: #c0c0c0" cellSpacing=0 cellPadding=0 width="100%" border=0><TBODY><tr><td style="HEIGHT: 19px; BACKGROUND-COLOR: #fbf8f1" align=left width="100%"><uc1:uscmenu id="Uscmenu1" runat="server"></uc1:uscmenu> </td></tr><tr><td style="BACKGROUND-COLOR: #d4d0c8" align=left width="100%">&nbsp;</td></tr><tr><td style="BACKGROUND-COLOR: #d4d0c8" align=left width="100%"><table id="user" cellSpacing=1 cellPadding=1 width="100%" border=0><TBODY><tr><td style="HEIGHT: 26px" class="header" width="100%">&nbsp;BẢNG CHẤM CÔNG THEO CA(Hành chính)<INPUT id="listidnhanvien" type=hidden runat="server" /><INPUT id="idngay" type=hidden runat="server" /></td></tr><tr><td vAlign=top width="100%"><table cellPadding=0 width="100%" border=0><TBODY><tr><td style="HEIGHT: auto" vAlign=top align=center width="100%"><table cellSpacing=0 cellPadding=0 width="98%" border=0><TBODY><TR style="PADDING-BOTTOM: 5px; PADDING-TOP: 10px"><td style="HEIGHT: 18px" align=left width="100%"><table style="HEIGHT: 17px" cellSpacing=0 cellPadding=0 width="100%" border=0><TBODY><TR style="DISPLAY: none"><td style="WIDTH: 29%; HEIGHT: 24px" noWrap align=right><SPAN class="ptext">Tháng năm làm việc:&nbsp; </SPAN></td><td style="WIDTH: 95%; HEIGHT: 24px" vAlign=top align=left><SPAN class="ptext">&nbsp;<asp:dropdownlist id="ddlthang" runat="server" width="78px"><asp:ListItem Value="0">--Th&#225;ng--</asp:ListItem>
...
<asp:ListItem>12</asp:ListItem>
</asp:dropdownlist> &nbsp;<asp:dropdownlist id="ddlnam" runat="server" width="99px"></asp:dropdownlist>&nbsp; <asp:imagebutton id="ImageButton1" tabIndex=11 onclick="ImageButton1_Click" runat="server" imageurl="../images/nut_search.jpg"></asp:imagebutton> </SPAN></td></tr><tr><td style="HEIGHT: auto" colSpan=2><table style="BORDER-RIGHT: 3px; BORDER-TOP: 3px; PADDING-LEFT: 0px; BORDER-LEFT: 3px; BORDER-BOTTOM: 3px; BACKGROUND-COLOR: white" cellSpacing=0 cellPadding=0 rules=none width=700><%--<tr>
                                                                                ...
                                                                                </tr>--%><TBODY><tr><td style="HEIGHT: 10px" colSpan=4></td></tr><tr><td style="PADDING-LEFT: 10px; WIDTH: 13%; HEIGHT: 41px" vAlign=top align=left><P class="ptext">Phòng&nbsp; </P></td><td style="PADDING-RIGHT: 0px; WIDTH: 25%; HEIGHT: 41px" vAlign=top align=left><P class="ptext"><%--<asp:textbox id="txtMaLoaiNgayNghi" runat="server" width="248px" tabindex="4"></asp:textbox>--%><asp:dropdownlist id="ddlPhongBan" tabIndex=1 runat="server" width="100%" CssClass="input" OnSelectedIndexChanged="ddlPhongBan_SelectedIndexChanged" AutoPostBack="True"></asp:dropdownlist> &nbsp;</P></td><td style="PADDING-RIGHT: 2px; WIDTH: 12%; HEIGHT: 41px" vAlign=top align=right><P class="ptext">Ca làm việc : </P></td><td style="PADDING-RIGHT: 0px; WIDTH: 40%; HEIGHT: 41px" vAlign=top align=left><P class="ptext"><asp:dropdownlist id="ddlCaLamViec" tabIndex=1 runat="server" width="63%" CssClass="input"></asp:dropdownlist> &nbsp;&nbsp;&nbsp; </P></td></tr><tr><td style="PADDING-LEFT: 10px; WIDTH: 13%; HEIGHT: 41px" vAlign=top align=left><P class="ptext">Nhân viên :</P></td><td style="PADDING-RIGHT: 0px; WIDTH: 25%; HEIGHT: 41px" vAlign=top align=left><P class="ptext"><%--<asp:textbox id="txtMaLoaiNgayNghi" runat="server" width="248px" tabindex="4"></asp:textbox>--%><asp:dropdownlist id="ddlNhanVien" tabIndex=1 runat="server" width="100%" CssClass="input"></asp:dropdownlist> &nbsp;</P></td><td style="PADDING-RIGHT: 2px; WIDTH: 12%; HEIGHT: 41px" vAlign=top align=right><P class="ptext">Ngày: </P></td><td style="PADDING-RIGHT: 0px; WIDTH: 40%; HEIGHT: 41px" vAlign=top align=left><P class="ptext"><asp:textbox id="txtNgay" tabIndex=5 runat="server" width="38%" CssClass="input"></asp:textbox> <INPUT id="Button2" onclick="dp_cal.toggle()" type=button value="..." />&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;<asp:button id="btnGetDanhSach" onclick="btnGetDanhSach_Click" runat="server" width="102px" CssClass="input" text="Lấy danh sách"></asp:button>&nbsp;</P></td></tr><%--<tr height="auto">
                                                                        <td colspan="4" style="height: auto" id="showtipNhanVien">
                                                                    </tr>--%></TBODY></TABLE></td></tr></TBODY></TABLE></td></tr></TBODY></TABLE></td></tr></TBODY></TABLE><table cellPadding=0 width="100%" border=0><TBODY><tr><td width="100%"><table class="khung" cellSpacing=1 cellPadding=1 width="100%" border=1><TBODY><tr><td class="ptext" align=center width="100%"><B><div style="OVERFLOW: auto" id="idthang" runat="server">THÔNG TIN CHẤM CÔNG THEO CA</div></b></td></tr><tr><td class="ptext" vAlign=top align=left width="100%"><div id="chitietchamcong" runat="server"><%--khoe--%><asp:DataGrid id="dgr" tabIndex=12 runat="server" BorderStyle="None" BackColor="White" CellPadding="4" OnItemDataBound="dgr_ItemDataBound" BorderColor="#3366CC" BorderWidth="1px" DataKeyField="idnhanvien" AutoGenerateColumns="False" AllowSorting="True" Width="100%">
...
<asp:TemplateColumn HeaderText="Ca làm việc"><ItemTemplate>
        <asp:TextBox BorderWidth="0" readonly="true" ID="tbgiabanhientai" runat="server" Text='<%#bind("tencalamviec") %>'></asp:TextBox>
...
<asp:BoundColumn DataField="idphanca" HeaderText="idphanca" Visible="False"></asp:BoundColumn>
