 <%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LoaiPhauThuat2.aspx.cs" Inherits="LoaiPhauThuat" Title="LoaiPhauThuat" %>
 ...
 function xoaontable(idkhoachinh,control){
             ...
             if(hoi){
                 ...
                 xmlHttp.open("GET", "../ajax/LoaiPhauThuat_ajax2.aspx?do=xoa&idkhoachinh=" + idkhoachinh + "&times=" + Math.random(), false);
                 xmlHttp.send(null);
             }
             }
 ...
 if(event.keyCode == 113){
         ...
         function ListControlTimKiemtenloaiphauthuat(control) {
             return " tenloaiphauthuat like N'%"+control.value+"%'";
         }
  ...
  function btLuuTable(control,functionlistcontroluutable)
         ...
         {
             var tenloaiphauthuat = document.getElementById(tablegrid).rows[i].cells[2].getElementsByTagName("input")[0].value;
             var ghichu = document.getElementById(tablegrid).rows[i].cells[3].getElementsByTagName("input")[0].value;
             return "../ajax/LoaiPhauThuat_ajax2.aspx?do=luuTable&tenloaiphauthuat=" + encodeURIComponent(tenloaiphauthuat) + "&ghichu=" + encodeURIComponent(ghichu) + "";
         }
 ...
 <asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
             <div class="shadow" style="margin-top:30px;padding: 2px 0px 2px 0px; background-color: #4473ca; border: 2px solid #cfcfcf;
                 ...
                 <%=hsLibrary.clDictionaryDB.sGetValueLanguage("LoaiPhauThuat")%></div>
 ...
 <uc2:TextBox id="tenloaiphauthuat" runat="server" IDTextBox="tenloaiphauthuat" onkeyup="Find(this,'ListControlTimKiemtenloaiphauthuat');" styleTextBox="width:250px" Title="tenloaiphauthuat">
             </uc2:TextBox>
 ...
 <div style="border: 1px solid #cfcfcf; background: white; text-align: center;
             ...
             <div style="overflow:auto">
                 <asp:GridView Width="800px" ID="gridTable" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="idloaiphauthuat" BackColor="White" PageSize="100" OnPageIndexChanging="gridTable_PageIndexChanging" OnRowDataBound="gridTable_RowDataBound" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" AllowSorting="True" ShowFooter="True">
                     <Columns>
 <asp:TemplateField HeaderText="stt">
     ...
     <ItemStyle Width="5%" />
                     ...
                     <asp:TemplateField>
                         <ItemTemplate>
                             <a onkeydown="chuyendong(this);" style='text-decoration:none;cursor:pointer;margin-right:10px;color:green;' onclick="xoaontable(this.name,this);" name="<%#Eval("idloaiphauthuat") %>"><%=hsLibrary.clDictionaryDB.sGetValueLanguage("delete") %></a>
                         </ItemTemplate>
                         <ItemStyle Width="5%" />
                     </asp:TemplateField>
                         <asp:TemplateField HeaderText="tenloaiphauthuat">
                             <ItemTemplate>
                             <input onfocusout="chuyenformout(this)" onfocus="chuyenform(this)" onkeydown="chuyendong(this);" style="width:90%;" value='<%#Eval("tenloaiphauthuat") %>' type="text"/>
                             </ItemTemplate>
                         </asp:TemplateField>
  ...
  <asp:TemplateField HeaderText="dongluu" Visible="False">
      ...
      <ItemStyle Width="30px" />
                         ...
                         <asp:TemplateField>
                             <ItemTemplate>
                                 <input type="hidden" value='<%#Eval("idloaiphauthuat") %>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                     </Columns>
