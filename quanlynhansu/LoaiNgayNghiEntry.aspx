<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LoaiNgayNghiEntry.aspx.cs" Inherits="LoaiNgayNghiEntry" %>
                                        ...
                                        <table id="user" cellspacing="1" cellpadding="1" width="100%" border="0" class="khung">
                                            <tr>
                                                <td align="center" style="width: 100%; background-color: #FBF8F1; height: 19px; background-image: url(../images/menu.jpg);
                                                    ...
                                                    QUẢN LÝ DANH MỤC LOẠI NGÀY NGHỈ
                                                </td>
                                            </tr>
                                            <tr>
                                                                    ...
                                                                    <tr style="padding-bottom: 5px; padding-top: 10px">
                                                                        <td align="center" width="100%" style="height: 81px; padding-left: 50px">
                                                                            <table width="400px" rules="none" style="border-color: Blue; border-style: double;
                                                                                ...
                                                                                <tr>
                                                                                    <td valign="top" nowrap align="right" style="height: 40px; padding-left: 10px; width: 130px;">
                                                                                        <p class="ptext">
                                                                                            Mã loại ngày nghỉ:&nbsp;
                                                                                        </p>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td valign="top" align="left" width="430" style="width: 430px; height: 40px;" colspan="3">
                                                                                        <p class="ptext">
                                                                                            <asp:textbox id="txtMoTa" runat="server" width="248px" tabindex="4" TextMode="MultiLine"></asp:textbox>
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                        ...
                                                        <tr>
                                                            <td valign="top" align="right" width="100%" colspan="2" height="20">
                                                                <asp:datagrid id="dgr" tabindex="12" runat="server" width="100%" allowsorting="True"
                                                                    autogeneratecolumns="False" datakeyfield="idloaingaynghi" borderwidth="1px" bordercolor="Silver"
...
<asp:BoundColumn DataField="maloaingaynghi" HeaderText="Mã loại ngày nghỉ">
<HeaderStyle Wrap="False" Width="25%"></HeaderStyle>

<ItemStyle Wrap="False"></ItemStyle>
</asp:BoundColumn>
<asp:BoundColumn DataField="mota" HeaderText="Mô tả">
