<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DanhSachNhanVienChiLuong.aspx.cs"
    Inherits="quanlynhansu_DanhSachNhanVienChiLuong" EnableEventValidation ="false" %>
...
<TABLE style="BACKGROUND-COLOR: #c0c0c0" cellSpacing=0 cellPadding=0 width="100%" border=0><TBODY><TR><TD style="HEIGHT: 19px; BACKGROUND-COLOR: #fbf8f1" align=left width="100%"><uc1:uscmenu id="Uscmenu1" runat="server"></uc1:uscmenu> </TD></TR><TR><TD style="BACKGROUND-COLOR: #d4d0c8" align=left width="100%">&nbsp; </TD></TR><TR><TD style="BACKGROUND-COLOR: #d4d0c8" align=left width="100%"><TABLE id="user" cellSpacing=1 cellPadding=1 width="100%" border=0><TBODY><TR><TD style="HEIGHT: 26px" class="header" width="100%">&nbsp;BẢNG CHI LƯƠNG NHÂN VIÊN </TD></TR><TR><TD vAlign=top width="100%"><TABLE cellPadding=0 width="100%" border=0><TBODY><TR><TD style="HEIGHT: 175px" vAlign=top align=center width="100%"><TABLE cellSpacing=0 cellPadding=0 width="98%" border=0><TBODY><TR style="PADDING-BOTTOM: 5px; PADDING-TOP: 10px"><TD style="HEIGHT: 18px" align=left width="100%"><TABLE style="HEIGHT: 17px" cellSpacing=0 cellPadding=0 width="100%" border=0><TBODY><TR><TD style="HEIGHT: 122px" colSpan=2><TABLE style="BORDER-RIGHT: 3px; BORDER-TOP: 3px; PADDING-LEFT: 0px; BORDER-LEFT: 3px; BORDER-BOTTOM: 3px; width: 780px;" cellSpacing=0 cellPadding=0 rules=groups bgColor=#b3b8e8 border=3><TBODY><TR><TD style="HEIGHT: 10px" colSpan=4></TD></TR><TR><TD style="PADDING-LEFT: 10px; WIDTH: 9%; HEIGHT: 41px" vAlign=top align=left><P class="ptext">Phòng&nbsp; </P></TD><TD style="PADDING-RIGHT: 0px; WIDTH: 25%; HEIGHT: 41px" vAlign=top align=left><P class="ptext"><asp:dropdownlist id="ddlPhongBan" tabIndex=1 runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlPhongBan_SelectedIndexChanged" width="100%" CssClass="input">
                                                                                 </asp:dropdownlist> &nbsp; </P></TD><TD style="PADDING-RIGHT: 2px; WIDTH: 29%; HEIGHT: 41px" vAlign=top align=right><P class="ptext">
                                                                                     Loại NV :<asp:dropdownlist id="ddlLoaiNV" runat="server" autopostback="True" cssclass="input"
                                                                                         onselectedindexchanged="ddlLoaiNV_SelectedIndexChanged" tabindex="1" width="63%"><asp:ListItem Value="-1">----Chọn loại NV----</asp:ListItem>
<asp:ListItem Value="0">Thường xuy&#234;n</asp:ListItem>
<asp:ListItem Value="1">Kh&#244;ng thường xuy&#234;n</asp:ListItem>
</asp:dropdownlist>
                                                                                 </P></TD><TD style="PADDING-RIGHT: 0px; WIDTH: 40%; HEIGHT: 41px" vAlign=top align=left><P class="ptext">
    &nbsp;Nhân viên : <asp:dropdownlist id="ddlNhanVien" tabIndex=1 runat="server" width="63%" CssClass="input">
                                                                                 </asp:dropdownlist> &nbsp;&nbsp;&nbsp; </P></TD></TR><TR><TD style="PADDING-LEFT: 10px; WIDTH: 9%; HEIGHT: 41px" vAlign=top align=left><P class="ptext">Tháng&nbsp;:</P></TD><TD style="PADDING-RIGHT: 0px; WIDTH: 25%; HEIGHT: 41px" vAlign=top align=left><P class="ptext"><asp:dropdownlist id="ddlThang" tabIndex=7 runat="server" width="23%">
...
<asp:ListItem Value="12">12</asp:ListItem>
                                                                                     ...
                                                                                     <asp:dropdownlist id="ddlNam" tabIndex=7 runat="server" width="35%"></asp:dropdownlist> </P></TD><TD style="PADDING-RIGHT: 2px; WIDTH: 29%; HEIGHT: 41px" vAlign=top align=right><P class="ptext"></P></TD><TD style="padding-left: 30px; WIDTH: 40%; HEIGHT: 41px" vAlign=top align=left><P class="ptext">&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <asp:button id="btnGetDanhSach" onclick="btnGetDanhSach_Click" runat="server" width="102px" CssClass="input" text="Lấy danh sách"></asp:button>&nbsp; </P></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE><TABLE cellPadding=0 width="100%" border=0><TBODY><TR><TD width="100%"><TABLE class="khung" cellSpacing=1 cellPadding=1 width="100%" border=1><TBODY><TR><TD class="ptext" align=left width="100%"><DIV style="PADDING-LEFT: 10px; OVERFLOW: auto" id="idthang" runat="server"><B>DANH SÁCH BẢNG CHI LƯƠNG NHÂN VIÊN &nbsp;&nbsp; <asp:Label id="lbThangNam" runat="server" Text=""></asp:Label></B> </DIV></TD></TR><TR><TD class="ptext" vAlign=top align=left width="2000px">
<DIV id="chitietchamcong" runat="server"><%--khoe--%>
<asp:DataGrid id="dgr" tabIndex=12 runat="server" BorderStyle="None" BackColor="White" CellPadding="4" OnEditCommand="Edit" OnItemDataBound="dgr_ItemDataBound" BorderColor="#3366CC" BorderWidth="1px" DataKeyField="idnhanvien" AutoGenerateColumns="False" AllowSorting="True" Width="100%">
...
<asp:BoundColumn DataField="LuongCBGio" HeaderText="Lương CB/Hệ số">
...
<asp:BoundColumn DataField="TongTienNgoaiGio" DataFormatString="{0:0,000}" HeaderText="PC ngo&#224;i giờ">
<HeaderStyle Wrap="False" Width="100px"></HeaderStyle>

<ItemStyle HorizontalAlign="Right" Wrap="False" Width="100px"></ItemStyle>
</asp:BoundColumn>
<asp:BoundColumn DataField="QuyTienLuong" DataFormatString="{0:0,000}" HeaderText="PC quỹ lương">
<HeaderStyle Wrap="False" Width="80px"></HeaderStyle>
...
<asp:TemplateColumn><ItemTemplate>
                                                    <asp:LinkButton ID="lbtnEdit" CommandName="Edit" text='<%#Eval("dachi") %>' runat="server" CssClass="alink3"><%#Eval("dachi") %></asp:LinkButton>                                                   
                                                    <asp:HiddenField  ID="txtIdLuongNhanVien" Value='<%#Eval("idluongnhanvien") %>' runat="server" />
