<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LoaiTangCaEntry.aspx.cs" Inherits="LoaiTangCaEntry" %>
                                                                            ...
                                                                            <table width="400px" rules="none" style="border-color: Blue; border-style: double;
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td valign="top" align="left" width="430" style="width: 430px; height: 40px;" colspan="3">
                                                                                        <p class="ptext">
                                                                                            <asp:textbox id="txttenLoaiTangCa" runat="server" width="248px" tabindex="4"></asp:textbox>
                                                                                        </p>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td valign="top" align="left" width="430" style="width: 430px; height: 40px;" colspan="3">
                                                                                        <p class="ptext">
                                                                                            <asp:textbox id="txtHeSoLuong" runat="server" width="248px" tabindex="4"></asp:textbox>
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                    ...
                                                    <table cellpadding="0" width="100%" border="0">
                                                        <tr>
                                                            <td align="left" style="width: 100%; background-color: #FBF8F1; height: 19px; background-image: url(../images/menu.jpg);
                                                                ...
                                                                THÔNG TIN DANH MỤC LOẠI TĂNG CA
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td valign="top" align="right" width="100%" colspan="2" height="20">
                                                                <asp:datagrid id="dgr" tabindex="12" runat="server" width="100%" allowsorting="True"
                                                                    autogeneratecolumns="False" datakeyfield="idloaitangca" borderwidth="1px" bordercolor="Silver"
                                                                    onitemdatabound="dgr_ItemDataBound" cellpadding="2" ondeletecommand="DelLoaiTangCa"
...
<asp:BoundColumn DataField="tenloaitangca" HeaderText="Tên loại tăng ca">
<HeaderStyle Wrap="False" Width="55%"></HeaderStyle>

<ItemStyle Wrap="False"></ItemStyle>
</asp:BoundColumn>
<asp:BoundColumn DataField="hesoluong" HeaderText="Hệ số lương">
