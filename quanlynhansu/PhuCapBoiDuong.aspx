<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PhuCapBoiDuong.aspx.cs" Inherits="PhuCapBoiDuong" %>
...
<asp:ListItem Value="12">12</asp:ListItem>
        ...
        <div style="background-color: #003399; height: auto; text-align: left; width: 100%">
            <span style="color: #ffffff; font-size: 14pt;"><strong>
                <div style="margin-top: 5px">
                    DANH SÁCH TIỀN PHỤ CẤP BỒI DƯỠNG&nbsp;&nbsp; <asp:Label id="lbThangNam" runat="server" Text=""></asp:Label></div>
            </strong></span>
        </div>
...
<asp:BoundColumn DataField="SoBenhNhan"  HeaderText="Số bệnh nhân">
<HeaderStyle Wrap="False" Width="5%"></HeaderStyle>

<ItemStyle HorizontalAlign="Right" Wrap="False"></ItemStyle>
</asp:BoundColumn>
<asp:BoundColumn DataField="giatrimuc" HeaderText="Hệ số phụ cấp">
<HeaderStyle Wrap="False" Width="5%"></HeaderStyle>
...
<asp:TemplateColumn HeaderText="" visible="false"><ItemTemplate>
        <asp:TextBox ID="txtSoBenhNhan" runat="server" Text='<%#Bind("SoBenhNhan") %>' Visible="false" BorderWidth="0"></asp:TextBox>
</ItemTemplate>
<HeaderStyle Width="2%"></HeaderStyle>
<ItemStyle Wrap="False" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False"></ItemStyle>
</asp:TemplateColumn>
