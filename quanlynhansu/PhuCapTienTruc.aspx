<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PhuCapTienTruc.aspx.cs" Inherits="PhuCapTienTruc" %>
...
<asp:ListItem Value="12">12</asp:ListItem>
        ...
        <div style="background-color: #003399; height: auto; text-align: left; width: 100%">
            <span style="color: #ffffff; font-size: 14pt;"><strong>
                <div style="margin-top: 5px">
                    DANH SÁCH TIỀN PHỤ CẤP TIỀN TRỰC&nbsp;&nbsp; <asp:Label id="lbThangNam" runat="server" Text=""></asp:Label></div>
            </strong></span>
        </div>
...
<asp:BoundColumn DataField="SoCaTruc"  HeaderText="Số ca trực">
<HeaderStyle Wrap="False" Width="5%"></HeaderStyle>

<ItemStyle HorizontalAlign="Right" Wrap="False"></ItemStyle>
</asp:BoundColumn>
<asp:BoundColumn DataField="giatrimuc" HeaderText="Số tiền theo ca">
<HeaderStyle Wrap="False" Width="5%"></HeaderStyle>
...
<asp:TemplateColumn HeaderText="" visible="false"><ItemTemplate>
        <asp:TextBox ID="txtSoCaTruc" runat="server" Text='<%#Bind("SoCaTruc") %>' Visible="false" BorderWidth="0"></asp:TextBox>
</ItemTemplate>
<HeaderStyle Width="2%"></HeaderStyle>
<ItemStyle Wrap="False" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False"></ItemStyle>
</asp:TemplateColumn>
