<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PhuCapTrachNhiem.aspx.cs" Inherits="PhuCapTrachNhiem" %>
...
<asp:ListItem Value="12">12</asp:ListItem>
        ...
        <div style="background-color: #003399; height: auto; text-align: left; width: 100%">
            <span style="color: #ffffff; font-size: 14pt;"><strong>
                <div style="margin-top: 5px">
                    DANH SÁCH TIỀN PHỤ CẤP TRÁCH NHIỆM &nbsp;&nbsp; <asp:Label id="lbThangNam" runat="server" Text=""></asp:Label></div>
            </strong></span>
        </div>
...
<asp:BoundColumn DataField="MucLuongCoBan" DataFormatString="{0:0,000}" HeaderText="Mức Lương CB">
<HeaderStyle Wrap="False" Width="5%"></HeaderStyle>
