<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BaoCaoTienTHCaKipKoTX.aspx.cs" Inherits="BaoCaoTienTHCaKipKoTX" %>
        ...
        <div style="background-color: #4D67A2; height: auto; text-align: left; width: 100%">
            <span style="color: #ffffff; font-size: 14pt;"><strong>
                <div style="margin-top: 5px">
                    BÁO CÁO TIỀN TỔNG HỢP CA KÍP MỔ BS KHÔNG THƯƠNG XUYÊN</div>
            </strong></span>
        </div>
        <br />
