<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PhuCapDocHai.aspx.cs" Inherits="PhuCapDocHai" %>
...
<asp:ListItem Value="12">12</asp:ListItem>
        ...
        <div style="background-color: #003399; height: auto; text-align: left; width: 100%">
            <span style="color: #ffffff; font-size: 14pt;"><strong>
                <div style="margin-top: 5px">
                    DANH SÁCH TIỀN PHỤ CẤP &nbsp;&nbsp; <asp:Label id="lbThangNam" runat="server" Text=""></asp:Label></div>
            </strong></span>
        </div>
