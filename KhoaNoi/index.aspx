<%@ Page Language="C#" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="khoanoi_index" %>
    ...
    <tr>
        <td width = "100%" align = "left" style ="background-color:#D4D0C8">
            <table border="0" cellpadding="1" cellspacing="1" width="100%" id="user">
                <tr>
                    <td width = "100%" class = "header" style ="background-color:#4D67A2"><span class="title" style ="color:#D4D0C8">PHÂN HỆ KHOA NỘI</span></td>
                </tr>
                <tr>
