<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DanhSachBenhNhanChoNhapKhoa.aspx.cs"
    Inherits="DanhSachBenhNhanChoNhapKhoaNoi" %>
                            ...
                            <table id="user" cellspacing="1" cellpadding="1" width="100%" border="0" class="khung">
                                <tr>
                                    <td class="title" align="center" style="background-color: #4D67A2">
                                        <span class="title" id="spHeader" runat="server"  style="color: #FFFFFF">DANH SÁCH BỆNH NHÂN CHỜ NHẬP KHOA</span></td>
                                </tr>
                                <tr>
                                    <td width="100%">
...
<asp:ListItem Value="1">Nữ</asp:ListItem>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td valign="top" align="left" style="width: 100px; height: 3px;" colspan="1">
                                                                            <asp:textbox id="txtTuNgay" runat="server" tabindex="6" width="80px"></asp:textbox>
                                                                        </td>
                                                                        <td valign="top" align="left" style="width: 100px; height: 3px;">
                                                                            Đến ngày :</td>
                                                                        <td valign="top" align="left" style="width: 250px; height: 3px;">
                                                                            <asp:textbox id="txtDenNgay" runat="server" tabindex="7" width="80px"></asp:textbox>
