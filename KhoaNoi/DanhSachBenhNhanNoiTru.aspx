<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DanhSachBenhNhanNoiTru.aspx.cs" Inherits="KhoaNoi_DanhSachBenhNhanNoiTru" %>
			    ...
			    <table id="user" cellSpacing="1" cellPadding="1" width="100%" border="0" class = "khung">
				    <tr>
				        <td class="title" align = "center" style ="background-color: #4D67A2">
			                <span class="title" id="spHeader" runat="server" style ="color:#FFFFFF">DANH SÁCH BỆNH NHÂN NỘI TRÚ</span></td>
				    </tr>
				    <TR>
					    <TD width="100%">
								    ...
								    <TD vAlign="top" align="center" width="100%" style="height: 133px">
									    <TABLE cellSpacing="0" cellPadding="0" width="98%" border="0">
										    ...
										    <TR style="PADDING-BOTTOM: 5px; PADDING-TOP: 10px">
											    <TD align="center" width="100%" style="height: auto">
												    ...
												    <tr id="trKhoa" runat="server">
												        ...
												        <td valign="top" align="left" style="WIDTH: 161px; height: 23px;" colspan="1">
												         ...
												         <td valign="top" align="left" style="WIDTH: 480px; height: 23px;" colspan="3">
												            <p class="ptext">
												            <%--<asp:checkbox runat="server" id="cbIsChuaNhapVien" Text="Chưa xét nhập viện"></asp:checkbox>--%>
...
<asp:ListItem Value="1">Nữ</asp:ListItem>
													...
													Từ ngày :
													  ...
													  <TD vAlign="top" align="left" style="WIDTH: 100px; height: 3px;" colspan="1">
													   <asp:textbox id="txtTuNgay" runat="server" visible="true"  onfocus="$(this).datepick();" onblur="nvk_testDate_this(this);" 
                                                              tabindex="6" width="80px" ></asp:textbox>
													  </TD>
													  <TD vAlign="top" align="left" style="WIDTH: 100px; height: 3px;" >
													  Đến ngày :</TD>
													  <td vAlign="top" align="left" style="WIDTH: 250px; height: 3px;" >
													  <asp:textbox id="txtDenNgay" runat="server" visible="true"  onfocus="$(this).datepick();" onblur="nvk_testDate_this(this);" 
...
<asp:LinkButton id="lbtnEdit" runat="server" __designer:wfdid="w6" CommandName="Edit" CommandArgument='<%# Eval("idbenhnhan") %>' width="60px" CssClass="alink3">Hồ sơ BA</asp:LinkButton> 
</ItemTemplate>
