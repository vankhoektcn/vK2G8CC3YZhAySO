<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_Rpt_MauC79A.aspx.cs" Inherits="frm_Rpt_MauC79A" %>

<%@ Register Src="~/VienPhi_BH/uscmenu.ascx" TagName="uscmenu" TagPrefix="uc1" %>
       ...
       <table width="100%" rules="groups" style="height: 86px">
                            <tr>
                                <td  align="center" style="height: 22px;border:1px; background-color:Blue; background-repeat:repeat-x;color:Black">
                                    <asp:Label ID="txtTieuDe" Text=" DANH SÁCH ĐỀ NGHỊ THANH TOÁN CHI PHÍ KHÁM CHỮA BỆNH NGOẠI TRÚ" runat="server" Font-Bold="True"
                                   ...
                                   <table rules="groups" style="width:800px">
                                        ...
                                        <tr>
                                            ...
                                            <td style="height: 21px; width:auto;">
                                                ...
                                                &nbsp;&nbsp;
                                                <asp:DropDownList ID="ddlLoaiBN" runat="server" Visible="false" Width="126px">
                                                    <asp:ListItem Value="NgoaiTru">Ngoại tr&#250;</asp:ListItem>
                                                    <asp:ListItem Value="NoiTru">Nội tr&#250;</asp:ListItem>
                                                </asp:DropDownList>
