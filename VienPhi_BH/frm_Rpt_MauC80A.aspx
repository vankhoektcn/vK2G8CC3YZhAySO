<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_Rpt_MauC80A.aspx.cs" Inherits="frm_Rpt_MauC80A" %>
       ...
       <table width="100%" rules="groups" style="height: 86px">
                            <tr>
                                <td  align="center" style="height: 22px;border:1px; background-color:Blue; background-repeat:repeat-x;color:Black">
                                    <asp:Label ID="txtTieuDe" Text=" DANH SÁCH ĐỀ NGHỊ THANH TOÁN CHI PHÍ KHÁM CHỮA BỆNH NỘI TRÚ" runat="server" Font-Bold="True"
