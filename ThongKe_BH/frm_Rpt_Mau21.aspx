<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_Rpt_Mau21.aspx.cs" Inherits="frm_Rpt_Mau21" %>
...
<body>
       ...
       <table width="100%" rules="groups" style="height: 86px">
                            <tr>
                                <td  align="center" style="height: 22px;border:1px; background-color:Blue; background-repeat:repeat-x;color:Black">
                                    <asp:Label ID="txtTieuDe" Text=" THỐNG KÊ DỊCH VỤ KỸ THUẬT SỬ DỤNG BỆNH NHÂN BHYT NGOẠI TRÚ" runat="server" Font-Bold="True"
    ...
    <div>
        ...
        <CR:CrystalReportViewer ID="R" runat="server"  />
