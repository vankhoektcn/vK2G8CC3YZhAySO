<%@ Page Language="C#" MasterPageFile="~/QuanLyNhaThuoc/Master_thuocBV.master" AutoEventWireup="true" CodeFile="frm_PhieuDaYCTra.aspx.cs" Inherits="frm_PhieuDaYCTra" Title="Untitled Page" %>
 ...
 <style type="text/css">
    ...
    <script type="text/javascript" src="../js/epoch_classes.js"></script>
     <script type="text/javascript">
        ...
        setTimeout(function() {
                document.getElementById(("ctl00_body_droplistidphongkhambenh_idphongkhambenh")).focus();
                var LoaiThuocDrop=document.getElementById(("ctl00_body_droplistidloaithuoc_idloaithuoc"));
                if(queryString('loaithuocid') != null)
                    LoaiThuocDrop.value=queryString('loaithuocid');//document.getElementById("ctl00_body_hdQueryIdLoaiThuoc").value;
                if(LoaiThuocDrop.value !="")
                    LoaiThuocDrop.disabled=true;
 ...
 for (var i = 0; i < document.forms[0].elements.length; i++) {
        ...
        idphongkhambenh.value = value[3];
         ghichu.value = value[4];
             ...
             xmlHttp.open("GET", "../ajax/frm_PhieuYCXuat_ajax.aspx?do=setTimKiemDaYCTra&idkhoachinh=" + idkhoatimkiem+"&dkMenu="+dkMenu+"&idkho="+idkho1+"&times=" + Math.random(), true);
             xmlHttp.send(null);
//             }
//             else{
//                            loadTableAjaxThuoc_ChiTietPhieuYCXuat('','');
//             }
         ...
         function ListControlThem() {
             ...
             return "../ajax/frm_PhieuYCXuat_ajax.aspx?do=Them&NgayYC="+ encodeURIComponent(NgayYC.value)+"&SoPhieu="+ encodeURIComponent(SoPhieu.value)+"&idphongkhambenh="+ encodeURIComponent(idphongkhambenh.value)+"&idloaithuoc=" + encodeURIComponent(idloaithuoc.value)+"&ghichu="+ encodeURIComponent(ghichu.value)+""   ;
         }
 ...
 function loadTableAjaxThuoc_ChiTietPhieuYCXuat(response,idkhoa)
         {
             if(idkhoa == null)
                 idkhoa = "";
             var idkho1=idphongkhambenh.value;
             var SoPhieuYC = document.getElementById("SoPhieu").value;   
             var idLoaiThuoc=document.getElementById(("ctl00_body_droplistidloaithuoc_idloaithuoc")).value
             if(idLoaiThuoc=="0" || idLoaiThuoc=="")
             {   return;
             }
             var dkMenu=queryString('dkmenu');
             var xmlHttp = GetMSXmlHttp();
             ...
             xmlHttp.open("GET", "../ajax/frm_PhieuYCXuat_ajax.aspx?do=LoadDanhSachPhieuDaYCTra&SoPhieuYC="+SoPhieuYC+"&IdKhoYC="+idphongkhambenh.value+"&NgayYC="+encodeURIComponent(NgayYC.value)+"&dkMenu="+dkMenu+"&idkhoachinh="+idkhoa+"&idkho="+idkho1+"&idloaithuoc="+idLoaiThuoc+"&random=" + Math.random(), true);
             xmlHttp.send(null);
         }
 function LoadDanhSachPhieuDaYCTra()
         {
             var idkho1=idphongkhambenh.value;
             var SoPhieuYC = document.getElementById("SoPhieu").value;   
             var idLoaiThuoc=document.getElementById(("ctl00_body_droplistidloaithuoc_idloaithuoc")).value
             ...
             xmlHttp.open("GET", "../ajax/frm_PhieuYCXuat_ajax.aspx?do=LoadDanhSachPhieuDaYCTra&SoPhieuYC="+SoPhieuYC+"&IdKhoYC="+idphongkhambenh.value+"&NgayYC="+encodeURIComponent(NgayYC.value)+"&dkMenu="+dkMenu+"&idkho="+idkho1+"&idloaithuoc="+idLoaiThuoc+"&random=" + Math.random(), true);
             xmlHttp.send(null);
         }
...
function Inphieu(idphieuTra)
{
    window.open('rpt_nvk_PhieuTraThuoc.aspx?IdPhieuTra='+idphieuTra,'_blank');
}
function SuaphieuYC(IdPhieuYC)
{
    var loaithuocid=document.getElementById(("ctl00_body_droplistidloaithuoc_idloaithuoc")).value;
    var idkho=document.getElementById(("ctl00_body_droplistidphongkhambenh_idphongkhambenh")).value;
    var NgayYeuCauSua=document.getElementById(("ctl00_body_NgayYC")).value;
    window.open('frm_PhieuBNTraThuoc.aspx?dkmenu='+queryString('dkmenu')+'#idkhoachinh='+IdPhieuYC+'&Update=1&loaithuocid='+loaithuocid+'&idkho='+idkho+'&NgayYeuCauSua='+NgayYeuCauSua+'','_blank','location=no,menubar=no,resizable=yes,scrollbars=1,status=no,toolbar=no');
}
     </script>
 </asp:Content>
 <asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
     <div style="margin-top: 10px; padding: 5px 5px 5px 5px; border: 1px solid #cfcfcf;background: #e9e9e9">
             <div style="padding: 2px 0px 2px 0px; background-color: #4D67A2; border: 1px solid #cfcfcf;
                 ...
                 <%--<%=hsLibrary.clDictionaryDB.sGetValueLanguage("Thuoc_PhieuYCXuat") %>--%>
                 Danh Sách Phiếu Yêu Cầu Trả Thuốc
                   </div>
 ...
 <div style="float: left; padding: 0px 20px 0px 20px; width: 443px; border-right: 1px solid #cfcfcf;
                     border-bottom: 1px solid #cfcfcf;">
                 <uc1:droplist id="droplistidphongkhambenh" runat="server" id_="idphongkhambenh" onload="loaddroplist4()" onchange="LoadDanhSachPhieuDaYCTra();"  title="Kho">
                 </uc1:droplist>
                 </div>
                 
 <div style="float: left; padding: 0px 20px 0px 20px; width: 443px; border-right: 1px solid #cfcfcf;
                     border-bottom: 1px solid #cfcfcf;">
                 <uc1:droplist id="droplistidloaithuoc" runat="server" id_="idloaithuoc" onload="loaddroplist5()"  onchange="LoadDanhSachPhieuDaYCTra()"  title="Loaithuoc">
                 </uc1:droplist>
                 </div>
                 <div style="float: left; padding: 0px 20px 0px 20px; width: 443px;height:40px; border-right: 1px solid #cfcfcf;
                     border-bottom: 1px solid #cfcfcf;">
