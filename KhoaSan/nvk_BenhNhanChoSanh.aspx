<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nvk_BenhNhanChoSanh.aspx.cs"
    Inherits="nvk_BenhNhanChoSanh" %>
...
{
        $("#divDanhSachBN").html("<span style='height: auto; width: 100%;text-align:center; color: Red; font-weight: bold;font-style:italic' class='Tieude'> Đang load bệnh nhân chờ Sanh.....<img id='imgLoading' src='../images/processing.gif' /></span>");
        var PathUrl="../ajax/nvk_BenhNhanChoSanh_ajax.aspx?do=btnTimKiem_click&idkhoa="+queryString("IdKhoa")+"&mabenhnhan="+$("#txtmabenhnhan").val()+"&tenbenhnhan="+encodeURIComponent($("#txttenbenhnhan").val())+"&tungay="+$("#txtTuNgay").val()+"&denngay="+$("#txtDenNgay").val()+"";	            
	        $.ajax
	            ({
                     type:"GET",
                     cache:false,
...
function DongKhamChoSanh_Click(idkhambenh,idctdkk,idbenhnhan,obj)
{
    //var link="../khambenh/frm_Edit_DSBNdakham.aspx?IdKhamBenh=" + idkhambenh + "&dkmenu=nomenu&IdKhoa="+queryString("IdKhoa")+"";
    var link="";
    if(idkhambenh >0)
        link="../KhamBenh_TH/KhamBenh.aspx?dkMenu=" + queryString("dkMenu") + "#idkhoachinh=" + idkhambenh + "";/////
    else
        link="../KhamBenh_TH/KhamBenh.aspx?dkMenu=KhamBenh_TH#idchitietdangkykham="+idctdkk+"&idbenhnhan="+idbenhnhan+"";
...
{
    $(obj).TimKiem({
        ajax:"../ajax/nvk_NhapKhoaSan_ajax.aspx?do=NhapHauSan_Click&idkhoa="+queryString("IdKhoa")+"&idnoitru="+idnoitru+"&idkhambenh="+idKB_NhapHS+"&IsHauSanh=1"
        ,title:"Nhập Bệnh Nhân Hậu Sản"
    },null,null,function(){});
}
function DongVaoChoSanh_Click(idnoitru,idKB_ChoSanh,obj)
{
    $(obj).TimKiem({
        ...
        ,title:"Cập Nhật Thông Tin Chờ Sanh"
    },null,null,function(){});
}
...
<form id="Form1" method="post" runat="server">
    ...
    <div id="divFather" style="width: 99%;">
        <div id="divHeader" style="background-color: #4D67A2; height: 25px;text-align:center;padding:5px 0px 0px 0px">
                                        <span class="title" style="color: #FFFFFF"><strong>BỆNH NHÂN ĐANG CHỜ SANH</strong></span>
...
<span class="spanText">Năm sinh:</span> <input type="text" id="namsinh" style="width: 80px;" />--%>
            ...
            <div class="divContent">
                <fieldset class="fieldset_ND">
                        <legend class="legend_ND">Danh Sách Bệnh Nhân Chờ Sanh</legend>
