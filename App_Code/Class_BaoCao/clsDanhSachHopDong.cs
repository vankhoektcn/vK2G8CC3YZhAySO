...
/// </summary>
public class clsDanhSachHopDong:ExportToExcel.Profess_ExportToExcelByCode
{
    public  string search = "";
    public clsDanhSachHopDong()
    {

    }
    public clsDanhSachHopDong(string search)
    {
        this.search = search;
    }
    ...
    {
        return "DanhSachHopDong.xls";//TÊN FIE GỐC TƯƠNG ĐƯƠNG VỚI CRYTAL REPORT
    }
    protected override string SetOutputFileName() 
    {
        return "DanhSachHopDong.xls";//TÊN FILE XUẤT RA
    }
    ...
    protected override System.Collections.Generic.List<string> SetListSumColumnName() // hàm cho phép tính tổng cộng trên những cột nào => có thể ko có hàm 
    {
        ...
        lst.Add("mucluongcoban"); //theo câu select
        //lst.Add("cot 2");
        //lst.Add("cot 3");
        return lst;
    }
    ...
    {
        System.Collections.Generic.List<string> lst = new System.Collections.Generic.List<string>();
        lst.Add("sapxep"); //theo câu select
        //lst.Add("manhanvien");
        return lst;
    }
