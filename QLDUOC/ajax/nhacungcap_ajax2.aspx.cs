    ...
    private void TimKiem()
    {
        ...
        if (search)
        {
          ...
          where " + process.sWhere() + " AND ISNULL(ISKT,0)=0");
            ...
            html += "<th>" + hsLibrary.clDictionaryDB.sGetValueLanguage("masothue") + "</th>";
            html += "<th  style='width:20px'>Kế toán?</th>";
            html += "<th></th>";
            html += "</tr>";
            if (table.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < table.Rows.Count; i++)
                {
                    ...
                    html += "<td><input mkv='true' id='masothue' type='text' value='" + table.Rows[i]["masothue"].ToString() + "' onfocusout='chuyenformout(this)' onfocus='chuyendong(this);chuyenphim(this);' style='width:100%' " + (!edit ? "disabled" : "") + "/></td>";
                    html += "<td align='center'><input mkv='true' id='IsKT' type='checkbox' onfocusout='chuyenformout(this)' onfocus='chuyendong(this);chuyenphim(this);' " + (table.Rows[i]["IsKT"].ToString() == "True" ? "checked" : "") + " " + (!edit ? "disabled" : "") + "/></td>";
        ...
        if (add)
        {
            ...
            html += "<td><input mkv='true' id='masothue' type='text' value='' onfocusout='chuyenformout(this)' onfocus='chuyendong(this);chuyenphim(this);' style='width:100%'/></td>";
            html += "<td align='center'><input mkv='true' id='IsKT' type='checkbox' onfocusout='chuyenformout(this)' onfocus='chuyendong(this);chuyenphim(this);' /></td>";
