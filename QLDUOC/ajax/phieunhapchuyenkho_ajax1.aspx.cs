 ...
 public partial class phieunhapkho_ajax : System.Web.UI.Page
 {
     protected DataProcess s_phieunhapkho()
     {
             ...
             phieunhapkho.data("idloainhap","4");
             ...
             phieunhapkho.data("SOPHIEUYC", Request.QueryString["SOPHIEUYC"]);
            return phieunhapkho;
     }
 ...
 html.AppendLine("<data id=\"mkv_nhacungcapid\">" + ((nhacungcapid.Rows.Count > 0) ? nhacungcapid.Rows[0]["tennhacungcap"] : "") + "</data>");
        ...
        if (StaticData.HavePermision(this, "phieunhapkho_Search"))
         {
             ...
             if (ngaythang != null && ngaythang != "")
             {
                 ...
                 sqlSelect += " and T.ngaythang<='" + ngaythang +"'";
             }
             if (TuNgay != null && TuNgay != "")
             {
                 if (TuNgay.Length == "01/01/2013,01/01/2013".Length)
                     TuNgay = TuNgay.Substring(0, "01/01/2013".Length);
             ...
             if (SOPHIEUYC != null && SOPHIEUYC != "")
                 sqlSelect += " and T.SOPHIEUYC LIKE '%" + SOPHIEUYC +"%'";
         ...
         if(table != null){if (table.Rows.Count > 0)
         {
             for (int i = 0; i < table.Rows.Count; i++)
             {
                 html.Append("<tr style='cursor:pointer;' onclick=\"setControlFind('" + table.Rows[i]["idphieunhap"].ToString() + "')\">");
                        ...
                        html.Append("<td>" + table.Rows[i]["ThanhTienNhap"].ToString() + "</td>");
     ...
     {
         StaticData.SetDefaultIdKho(this,null,null,null,null);
     }
 }//END CLASS
