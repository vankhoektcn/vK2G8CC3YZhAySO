...
public partial class chitietphieunhapkho_ajax : System.Web.UI.Page
{
    protected DataProcess s_chitietphieunhapkho()
    {
        ...
        chitietphieunhapkho.data("IDKHO_NHAP", idkho);
    ...
    private void TimKiem()
    {
        if (StaticData.HavePermision(this, "chitietphieunhapkho_Search"))
        {
            ...
            if (idkho_nhap == null || idkho_nhap == "")
                idkho_nhap = Request.QueryString["IdKho"];
            if (idkho_nhap == null || idkho_nhap == "")
                idkho_nhap = StaticData.MacDinhKhoNhapMuaID;
            ...
            string sqlSelect = @"select STT=row_number() over (order by T.idchitietphieunhapkho),T.*
                   ...
                   ,E.TenKho as KhoNhap
                   ,F.TenNhaCungCap
                   ,G.tenloainhap,A.SOHOADON,A.NGAYTHANG,A.NGAYHOADON
                ...
                where A.IDLOAINHAP=1 AND T.IDKHO_NHAP= "+idkho_nhap;
            ...
            if (nhacungcapid != null && nhacungcapid != "")
                sqlSelect += "    AND a.nhacungcapid =" + nhacungcapid;
            ...
            html.Append("<th>" + hsLibrary.clDictionaryDB.sGetValueLanguage("Số H.Đ") + "</th>");
            html.Append("<th>" + hsLibrary.clDictionaryDB.sGetValueLanguage("Ngày H.Đ") + "</th>");
            html.Append("<th>" + hsLibrary.clDictionaryDB.sGetValueLanguage("NgayCT") + "</th>");
            ...
            //html.Append("<th>" + hsLibrary.clDictionaryDB.sGetValueLanguage("Kho") + "</th>");
            //html.Append("<th>" + hsLibrary.clDictionaryDB.sGetValueLanguage("LoaiNhap") + "</th>");
            ...
            if (table != null)
            {
                if (table.Rows.Count > 0)
                {
                    for (int i = 0; i < table.Rows.Count; i++)
                    {
                        ...
                        string ngayhoadon = table.Rows[i]["ngayhoadon"].ToString();
                        if (ngayhoadon != "")
                        {
                            html.Append("<td>" + DateTime.Parse(ngayhoadon).ToString("dd/MM/yyyy") + "</td>");
                        }
                        ...
                        html.Append("<td>" + string.Format("{0:0,0.##}", table.Rows[i]["DonGiaView"]) + "</td>");
                        //html.Append("<td>" + table.Rows[i]["chietkhau"].ToString() + "</td>");
                        //html.Append("<td>" + table.Rows[i]["vat"].ToString() + "</td>");
                        //html.Append("<td>" + table.Rows[i]["thanhtientruocthue"].ToString() + "</td>");
                        html.Append("<td>" + string.Format("{0:0,0.##}", table.Rows[i]["thanhtien"]) + "</td>");
