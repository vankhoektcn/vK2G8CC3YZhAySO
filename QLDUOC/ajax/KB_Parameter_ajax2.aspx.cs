 ...
 public partial class KB_Parameter_ajax : System.Web.UI.Page
 {
 ...
 html+= "<td><input mkv='true' id='ParaName' type='text' value='" + table.Rows[i]["ParaName"].ToString()+ "' onfocusout='chuyenformout(this)' onfocus='chuyendong(this);chuyenphim(this);' style='width:100%'/></td>";
 html+= "<td><input mkv='true' id='ParaValue' type='text' value='" + table.Rows[i]["ParaValue"].ToString()+ "' onfocusout='chuyenformout(this)' onfocus='chuyendong(this);chuyenphim(this);' style='width:100%'/></td>";
 html+= "<td><input mkv='true' id='Description' type='text' value='" + table.Rows[i]["Description"].ToString()+ "' onfocusout='chuyenformout(this)' onfocus='chuyendong(this);chuyenphim(this);' style='width:100%'/></td>";
