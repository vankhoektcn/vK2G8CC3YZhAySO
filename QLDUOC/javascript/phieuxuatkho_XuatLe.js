...
setIdKho();
       ...
       setControlFind($.mkv.queryString("idkhoachinh"));
         $("#luu").click(function () {
           $(this).Luu({
                 ajax:"../ajax/phieuxuatkho_XuatLe_ajax.aspx?do=Luu"
                 +"&IdKho_Prev="+IdKho_Prev
                   ...
                   $.LuuTable({
                         ajax:"../ajax/phieuxuatkho_XuatLe_ajax.aspx?do=luuTableHS_OutPutDetail&IdPhieuXuat=" + $.mkv.queryString("idkhoachinh")
                         +"&IdKho_Prev="+IdKho_Prev
                         +"&NgayThang_Prev="+NgayThang_Prev
                         +"&IdKho2_Prev="+IdKho2_Prev
                         +"&IdKho="+$("#idkho").val()
                    ...
                    $.ajax({
                        async:false,
                        cache:false,
                        url:"../ajax/phieuxuatkho_XuatLe_ajax.aspx?do=GetMaPhieuXuat&IdPhieuXuat=" + $.mkv.queryString("idkhoachinh"),
                        success:function(data){
                            $("#maphieuxuat").val(data.split("|")[0]);
                            
                             IdKho_Prev=     data.split("|")[2];
                             NgayThang_Prev= data.split("|")[3];
                             IdKho2_Prev=    data.split("|")[4];
                             MaPhieuXuat_Prev=    data.split("|")[5];
                             if(data.split("|")[6]!="")
                              alert(data.split("|")[6]);
                        }
                    });     
           ...
           var today = new Date();
            ...
            $("#ngaythang").val(dd + "/" + mm + "/" + yyyy);
             $.ajax({
                    async:false,
                    cache:false,
                    url:"../ajax/phieuxuatkho_XuatLe_ajax.aspx?do=PrevInfo",
                    success:function(data){
        ...
        $("#xoa").click(function () {
           $(this).Xoa({
                 ajax:"../ajax/phieuxuatkho_XuatLe_ajax.aspx?do=xoa"
            },null,function () {
                 loadTableAjaxHS_OutPutDetail('');
             });
        });
  ...
  function setIdKho()
 {
    ...
    $.BindFind({
        ajax:"../ajax/phieuxuatkho_XuatLe_ajax.aspx?do=setIdKho"
   ...
   function setControlFind(idkhoatimkiem) {
      if(idkhoatimkiem != "" && idkhoatimkiem != null){
         $.BindFind({ajax:"../ajax/phieuxuatkho_XuatLe_ajax.aspx?do=setTimKiem&idkhoachinh="+idkhoatimkiem},null,function () {
  ...
  function Find(control,page) {
      if(page == null)page = "1";
      $(control).TimKiem({
             ajax:"../ajax/phieuxuatkho_XuatLe_ajax.aspx?do=TimKiem&page="+page 
             ,width:"1000"
       },null,function(data){
            if(data==null|| data==""){
                $.mkv.closeDivTimKiem();
 ...
 function xoaontable(control,bool){
   if(bool || bool == null)
      $(control).XoaRow({
         ajax:"../ajax/phieuxuatkho_XuatLe_ajax.aspx?do=xoaHS_OutPutDetail"
      });
 }
 function loadTableAjaxHS_OutPutDetail(idkhoa,page)
 {
     if(idkhoa == null) idkhoa = "";
         ...
         type:"GET",
         cache:false,
         url:"../ajax/phieuxuatkho_XuatLe_ajax.aspx?do=loadTableHS_OutPutDetail&idphieuxuat="+idkhoa+"&page="+page,
 ...
 {
     $(obj).unautocomplete().autocomplete("../ajax/phieuxuatkho_XuatLe_ajax.aspx?do=IdThuocSearch&loaithuoc="+$("#IdLoaiThuoc").val()+"&idkho="+$("#idkho").val()+"&NgayCT="+$("#ngaythang").val()
//      +"&Gio="+$("#gio").val()
//     +"&Phut="+$("#phut").val()
     ,{
     minChars:0,
 ...
 {
     $(obj).unautocomplete().autocomplete("../ajax/phieuxuatkho_XuatLe_ajax.aspx?do=UnitIDSearch",{
     minChars:0,
     width:350,
     scroll:true,
     formatItem:function (data) {
 ...
 {
     $(obj).unautocomplete().autocomplete("../ajax/phieuxuatkho_XuatLe_ajax.aspx?do=idkhoSearch"
        +"&idkhoa="+$.mkv.queryString("idkhoa")
        +"&idkho="+$.mkv.queryString("idkho")
        ,{
     minChars:0,
 ...
 {
     $(obj).unautocomplete().autocomplete("../ajax/phieuxuatkho_XuatLe_ajax.aspx?do=idkhachhangsearch",{
     minChars:0,
     width:250,
     scroll:true,
     header:false,
 ...
 {
     $(obj).unautocomplete().autocomplete("../ajax/phieuxuatkho_XuatLe_ajax.aspx?do=IdLoaiThuocSearch" + "&LoaiThuocID="+$.mkv.queryString("LoaiThuocID"),{
     minChars:0,
     width:350,
     scroll:true,
     formatItem:function (data) {
