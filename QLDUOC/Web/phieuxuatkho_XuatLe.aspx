 <%@ Page Language="C#" MasterPageFile="../MasterPage.master" AutoEventWireup="true" CodeFile="phieuxuatkho_XuatLe.aspx.cs" Inherits="phieuxuatkho_XuatLe" Title="phieuxuatkho_XuatLe" %>
 <asp:Content ID="Content1" ContentPlaceHolderID="header" Runat="Server">
     <script type="text/javascript" src="../javascript/phieuxuatkho_XuatLe.js">
     </script>
         <style>
    .div-Out
    {
 ...
 <asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
     <div class="body-div">
             <p class="header-div">
                 <%=hsLibrary.clDictionaryDB.sGetValueLanguage("PHIẾU XUẤT KHO")%>
           </p>
 <div class="in-a">
 <div class="div-Out">
     <h4>
 ...
 <div class="div-Out">
     ...
     <p>
        ...
        <input mkv="true" id="mkv_idkhachhang" type="text" onfocus="Find(this);chuyenphim(this);idkhachhangsearch(this);" class="down_select" style="width:90%"/>
     </p>
 </div>
 <div class="div-Out">
     <h4>
