 ...
 <div class="div-Out">
     ...
     <p>
        ...
        <input mkv="true" id="mkv_IdKho" type="text" onfocus="chuyenphim(this);IdKhoSearch(this);" class="down_select" style="width:90%"/>
     </p>
 </div>
 <div class="div-Out">
     <h4>
     ...
     <p>
        <input mkv="true" id="TuNgay" type="text" onfocus="chuyenphim(this);$(this).datepick();" onblur="TestDate(this);"  style="width:30%"/>
        <input mkv="true" id="tugio" type="text" onfocus="chuyenphim(this);"   style="width:15px"/>
        <input mkv="true" id="tuphut" type="text" onfocus="chuyenphim(this); "  style="width:15px"/>
     </p>
 </div>
 <div class="div-Out">
     <h4>
     ...
     <p>
        <input mkv="true" id="DenNgay" type="text" onfocus="chuyenphim(this);$(this).datepick();" onblur="TestDate(this);"  style="width:30%"/>
        <input mkv="true" id="dengio" type="text" onfocus="chuyenphim(this);"   style="width:15px"/>
        <input mkv="true" id="denphut" type="text" onfocus="chuyenphim(this); "  style="width:15px"/>
     </p>
 </div>
 <div class="div-Out">
     <h4>
     ...
     <p>
        ...
        <input mkv="true" id="mkv_LoaiThuocID" type="text" onfocus="chuyenphim(this);LoaiThuocIDSearch(this);" class="down_select" style="width:90%"/>
     </p>
 </div>
 <div class="div-Out">
     <h4>
     ...
     <p>
        ...
        <input mkv="true" id="TenThuoc" type="text" onfocus="chuyenphim(this);IdThuocSearch(this);" class="down_select" style="width:90%"/>
     </p>
 </div>
 ...
 <div class="div-Out" style="width:600px!important">
     ...
     <p style="width:75.5%!important">
        ...
        <input mkv="true" id="IsOrderByName" type="checkbox"  />
         &nbsp; ; <%=hsLibrary.clDictionaryDB.sGetValueLanguage("Có Đ.Giá")%>
        <input mkv="true" id="IsHaveDonGia" type="checkbox" onchange="Change_IsHaveDonGia();" />
         &nbsp; ; <%=hsLibrary.clDictionaryDB.sGetValueLanguage("IsSoLuong")%> <input mkv="true" id="IsSoLuong" type="checkbox"  onchange="Change_IsSoLuong();"/>  &nbsp; ;
         <%=hsLibrary.clDictionaryDB.sGetValueLanguage("Rút gọn")%>  <input mkv="true" id="IsRutGon" type="checkbox" onchange="Change_IsRutGon();" />
     </p>
 </div>
