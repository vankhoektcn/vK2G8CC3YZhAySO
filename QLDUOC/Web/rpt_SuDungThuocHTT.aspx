<%@ Page Language="C#" MasterPageFile="~/QLDUOC/MasterPage.master" AutoEventWireup="true"
    CodeFile="rpt_SuDungThuocHTT.aspx.cs" Inherits="QLDUOC_Web_rpt_SuDungThuocHTT"
    Title="Báo cáo sử dụng thuốc - hướng tâm thần" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="body-div">
        <p class="header-div">
            <%=hsLibrary.clDictionaryDB.sGetValueLanguage("Báo cáo sử dụng thuốc - hướng tâm thần")%>
        </p>
        <div class="in-a">
            <div class="div-Out">
                <h4>
