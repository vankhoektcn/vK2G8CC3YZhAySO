<%@ Page Language="C#" MasterPageFile="~/QLDUOC/MasterPage.master" AutoEventWireup="true"
    CodeFile="rpt_SuDungHoaChat.aspx.cs" Inherits="QLDUOC_Web_rpt_SuDungHoaChat"
    Title="Báo cáo sử dụng hóa chấ" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="body-div">
        <p class="header-div">
            <%=hsLibrary.clDictionaryDB.sGetValueLanguage("Báo cáo sử dụng hóa chất")%>
        </p>
        <div class="in-a">
            <div class="div-Out">
                <h4>
