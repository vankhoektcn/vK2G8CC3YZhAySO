<%@ Page Language="C#" MasterPageFile="~/QLDUOC/MasterPage.master" AutoEventWireup="true"
    CodeFile="HS_TONKHO_Save3_new.aspx.cs" Inherits="HS_TONKHO_Save3_new" Title="HS_TONKHO_Save" %>

<asp:Content ID="Content1" ContentPlaceHolderID="header" runat="Server">

    <script type="text/javascript" src="../javascript/HS_TONKHO_Save3_new.js">
    </script>
    <style type="text/css">
