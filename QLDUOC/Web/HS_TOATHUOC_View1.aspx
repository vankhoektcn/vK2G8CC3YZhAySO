<%@ Page Language="C#" MasterPageFile="../MasterPage.master" AutoEventWireup="true"
    CodeFile="HS_TOATHUOC_View1.aspx.cs" Inherits="HS_TOATHUOC_View" Title="HS_TOATHUOC_View" %>

<asp:Content ID="Content1" ContentPlaceHolderID="header" runat="Server">

    <script type="text/javascript" src="../javascript/HS_TOATHUOC_View1.js">
    </script>
    <style type="text/css">
        .div-Out
        {
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
        ...
        <div class="in-a">
            ...
            <div class="div-Out">
                <h4>
                    ...
                    <input id="timKiem" search="<%=StaticData.HavePermision(this, "HS_TOATHUOC_View_Search") %>"
    ...
    <div class="in-b" id="tableAjax_HS_TOATHUOC_View">
    </div>
</asp:Content>
