...
public partial class QLDUOC_Web_rpt_DuTruThuocMonth : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            bindkho();
            this.txtMonth.Value = DateTime.Now.AddMonths(1).ToString("MM");
            this.txtYear.Value = DateTime.Now.AddMonths(1).ToString("yyyy");
        }
    ...
    protected void btnTim_Click(object sender, EventArgs e)
    {
        ...
        this.bbkn.Year = this.txtYear.Value.Trim();
        this.bbkn.Month = this.txtMonth.Value.Trim();
