<%@ Page Language="C#" MasterPageFile="~/QLDUOC/MasterPage.master" AutoEventWireup="true"
    CodeFile="rpt_SuDungThuocGN.aspx.cs" Inherits="QLDUOC_Web_rpt_SuDungThuocGN"
    Title="Báo cáo Sử dụng thuốc - gây nghiện" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="body-div">
        <p class="header-div">
            <%=hsLibrary.clDictionaryDB.sGetValueLanguage("Báo cáo sử dụng thuốc - gây nghiện")%>
        </p>
        <div class="in-a">
            <div class="div-Out">
                <h4>
