<%@ Page Language="C#" MasterPageFile="../MasterPage_new.master" AutoEventWireup="true"
    CodeFile="frm_DM_DonViTinh.aspx.cs" Inherits="frm_DM_DonViTinh" Title="Thuoc_DonViTinh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="header" runat="Server">

    <script type="text/javascript" src="../javascript/frm_DM_DonViTinh.js">
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="body-div">
        ...
        <div class="header-div">
            <%=hsLibrary.clDictionaryDB.sGetValueLanguage("Thuoc_DonViTinh")%>
        </div>
        <div class="in-a">
            <div class="div-Out">
                <div class="div-Left">
                ...
                <div class="div-Right">
                    <input mkv="true" id="TenDVT" type="text" onfocus="Find(this);chuyenphim(this);"
                        style="width: 90%" />
                </div>
            </div>
        </div>
    ...
    <div class="body-div-button">
        ...
        <div class="in-b" id="tableAjax_Thuoc_DonViTinh">
        </div>
        <div class="in-c">
