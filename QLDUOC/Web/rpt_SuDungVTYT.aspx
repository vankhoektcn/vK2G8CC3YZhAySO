<%@ Page Language="C#" MasterPageFile="~/QLDUOC/MasterPage.master" AutoEventWireup="true"
    CodeFile="rpt_SuDungVTYT.aspx.cs" Inherits="QLDUOC_Web_rpt_SuDungVTYT" Title="Báo cáo sử dụng vật tư y tế" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="body-div">
        <p class="header-div">
            <%=hsLibrary.clDictionaryDB.sGetValueLanguage("Báo cáo sử dụng vật tư y tế")%>
        </p>
        <div class="in-a">
            <div class="div-Out">
                <h4>
