<%@ Page Language="C#" MasterPageFile="../MasterPage.master" AutoEventWireup="true"
    CodeFile="phieunhapkho3_dieuchinh.aspx.cs" Inherits="phieunhapkho3_dieuchinh" Title="phieunhapkho3_dieuchinh" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="body-div">
        <p class="header-div">
            <%=hsLibrary.clDictionaryDB.sGetValueLanguage("PHIẾU NHẬP ĐIỀU CHỈNH")%>
        </p>
        <div class="in-a">
            <div class="div-Out">
                <h4>
            ...
            <div class="div-Out">
                <h4>
                    ...
                    <input mkv="true" id="idloainhap" value="5"  type="hidden" />
                </h4>
            </div>
        </div>
