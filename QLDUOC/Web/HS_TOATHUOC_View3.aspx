<%@ Page Language="C#" MasterPageFile="../MasterPage.master" AutoEventWireup="true"
    CodeFile="HS_TOATHUOC_View3.aspx.cs" Inherits="HS_TOATHUOC_View" Title="HS_TOATHUOC_View" %>

<asp:Content ID="Content1" ContentPlaceHolderID="header" runat="Server">

    <script type="text/javascript" src="../javascript/HS_TOATHUOC_View3.js">
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="body-div">
        <p class="header-div">
            <%=hsLibrary.clDictionaryDB.sGetValueLanguage("CHI TIẾT TOA THUỐC BỆNH NHÂN")%>
        </p>
        <div class="in-a">
            <div class="div-Out">
                <h4>
        ...
        <a class="reload" onclick="loadTableAjaxHS_ToaThuoc_ViewDetail($.mkv.queryString('idkhoachinh'))">
        </a>
        <div id="tableAjax_HS_ToaThuoc_ViewDetail" class="in-b">
        </div>
    </div>
    <div class="body-div-button">
        <p class="in-a">
            <input id="xoa" delete="<%=StaticData.HavePermision(this, "HS_TOATHUOC_View_Delete") %>"
                type="button" style="display: none" value="<%=hsLibrary.clDictionaryDB.sGetValueLanguage("delete") %>" />
            <input id="PhatThuoc" search="<%=StaticData.HavePermision(this, "HS_TOATHUOC_View_Search") %>"
                type="button" value="<%=hsLibrary.clDictionaryDB.sGetValueLanguage("Xuất kho") %>" />
            <input id="InBV01" search="<%=StaticData.HavePermision(this, "HS_TOATHUOC_View_Search") %>"
